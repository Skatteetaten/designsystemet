import{j as e}from"./jsx-runtime-Nms4Y4qS.js";import{P as f}from"./index-DWqb7jS3.js";import{w as y,e as r}from"./index-B8otpkpo.js";import{l as t,w as v}from"./storybook.testing.utils-CMs160i9.js";import"./index-BwDkhjyp.js";import"./_commonjsHelpers-BosuxZz1.js";import"./index-C498nvnC.js";const J=["standard","ingress"],na={component:f,title:"Tester/Paragraph",argTypes:{key:{table:{disable:!0}},ref:{table:{disable:!0}},className:{table:{disable:!0}},id:{table:{disable:!0}},lang:{table:{disable:!0}},"data-testid":{table:{disable:!0}},canBeManuallyFocused:{table:{disable:!0}},children:{table:{disable:!0},control:"text"},hasSpacing:{table:{disable:!0}},variant:{table:{disable:!0},options:[...J],control:"radio"}}},s={children:t},o={name:"With Ref (FA1)",args:{...s,ref:a=>{a&&(a.id="dummyIdForwardedFromRef")}},argTypes:{ref:{table:{disable:!1}}},parameters:{imageSnapshot:{disable:!0}},play:async({canvasElement:a})=>{const n=y(a).getByText(t);await r(n).toHaveAttribute("id","dummyIdForwardedFromRef")}},d={name:"With Attributes (FA2-5)",args:{...s,id:"htmlId",className:"dummyClassname",lang:"nb","data-testid":"123ID"},argTypes:{id:{table:{disable:!1}},className:{table:{disable:!1}},lang:{table:{disable:!1}},"data-testid":{table:{disable:!1}}},play:async({canvasElement:a})=>{const n=y(a).getByText(t);await r(n).toHaveClass("dummyClassname"),await r(n).toHaveAttribute("id","htmlId"),await r(n).toHaveAttribute("lang","nb"),await r(n).toHaveAttribute("data-testid","123ID")}},p={name:"Is <p>-element (B1)",args:{...s},parameters:{imageSnapshot:{disable:!0}},play:async({canvasElement:a})=>{const l=y(a);await r(l.getByText(t).nodeName).toBe("P")}},K=a=>e.jsx(f,{...a,children:e.jsxs("span",{children:["Tekstavsnitt som kan inneholde en lengre tekst. Husk å følge klarspråkprinsippene når en skriver tekster. I dette tilfellet skriver bare litt ekstra tekst for å få litt ",e.jsx("strong",{children:"innhold "}),", men ",e.jsx("em",{children:"normalt "}),"vil en ønske å skrive så konsentret som mulig. Mange brukere leser bare de første ordene i en tekst, eller hopper ganske enkelt over den. Dette er en ",e.jsx("a",{href:"https://www.yr.no/nb/v%C3%A6rvarsel/daglig-tabell/2-460499/Latvia/Bauskas%20Rajons/Codes%20pagasts/Code",children:"lenke"})," for å sjekke været i ",e.jsx("code",{children:"Code "}),"som er en ",e.jsx("small",{children:"small "}),"landsby i et land med mange ",e.jsx("mark",{children:"mark "}),"og et språk uten ",e.jsx("b",{children:"b "}),"eller ",e.jsx("i",{children:"i"}),"."]})}),c={render:K,name:"With Markup (A2, B2)",args:{...s},argTypes:{children:{table:{disable:!1},control:{disable:!0}}},parameters:{imageSnapshot:{hover:`${v} > p a`,focus:`${v} > p a`}}},i=a=>e.jsxs(e.Fragment,{children:[e.jsx(f,{...a}),e.jsx(f,{...a})]}),m={render:i,name:"Defaults Variant Standard (A1, B2)",args:{...s},argTypes:{children:{table:{disable:!1}}}},g={render:i,name:"Variant Ingress (A1)",args:{...s,variant:"ingress"},argTypes:{variant:{table:{disable:!1}}}},u={render:i,name:"With Spacing Variant Standard (A3)",args:{...s,hasSpacing:!0},argTypes:{hasSpacing:{table:{disable:!1}}}},h={render:i,name:"With Spacing Variant Ingress (A3)",args:{...s,hasSpacing:!0,variant:"ingress"},argTypes:{hasSpacing:{table:{disable:!1}},variant:{table:{disable:!1}}}},b={render:i,args:{...s,canBeManuallyFocused:!0},argTypes:{canBeManuallyFocused:{table:{disable:!1}}},play:async({canvasElement:a})=>{const n=y(a).getAllByText(t)[1];n.focus(),await r(n).toBeInTheDocument(),await r(n).toHaveAttribute("tabIndex","-1")}};var S,T,A;o.parameters={...o.parameters,docs:{...(S=o.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: 'With Ref (FA1)',
  args: {
    ...defaultArgs,
...
} satisfies Story`,...(E=(H=m.parameters)==null?void 0:H.docs)==null?void 0:E.source}}};var V,C,D;g.parameters={...g.parameters,docs:{...(V=g.parameters)==null?void 0:V.docs,source:{originalSource:`{
  render: TemplateWithTwoParagraphs,
...
} satisfies Story`,...(D=(C=g.parameters)==null?void 0:C.docs)==null?void 0:D.source}}};var R,N,$;u.parameters={...u.parameters,docs:{...(R=u.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: TemplateWithTwoParagraphs,
...
} satisfies Story`,...(G=(z=b.parameters)==null?void 0:z.docs)==null?void 0:G.source}}};const sa=["WithRef","WithAttributes","IsPElement","WithMarkup","Defaults","VariantIngress","WithSpacing","VariantIngressWithSpacing","WithCanBeManuallyFocused"];export{m as Defaults,p as IsPElement,g as VariantIngress,h as VariantIngressWithSpacing,d as WithAttributes,b as WithCanBeManuallyFocused,c as WithMarkup,o as WithRef,u as WithSpacing,sa as __namedExportsOrder,na as default};
//# sourceMappingURL=Paragraph.test.stories-C8RMVocj.js.map
