...
} satisfies Story`,...T.parameters?.docs?.source}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
...
} satisfies Story`,...g.parameters?.docs?.source}}};const N=["WithRef","WithAttributes","WithCustomClassNames","Defaults","WithChildren","WithMobileScreen","WithWideScreen","WithVisibilityThreshold","WithShadowDom","WithNotScrollToMain"],j=Object.freeze(Object.defineProperty({__proto__:null,Defaults:u,WithAttributes:m,WithChildren:p,WithCustomClassNames:d,WithMobileScreen:h,WithNotScrollToMain:g,WithRef:c,WithShadowDom:T,WithVisibilityThreshold:y,WithWideScreen:b,__namedExportsOrder:N,default:E},Symbol.toStringTag,{value:"Module"}));export{j as S};
//# sourceMappingURL=ScrollToTopButton.test.stories-d9ge9XuL.js.map
