import{j as a}from"./jsx-runtime-BjG_zV1W.js";import{r as n}from"./index-D_ouKaeX.js";import{b}from"./index-CGk5cNE3.js";import{e as k,R as r}from"./index-DkXzVmhj.js";import{c as e,h as d}from"./helpers-B90wjoUE.js";import{S as p}from"./icon.systems-DGFW7KrD.js";import{e as x}from"./stories.utils-Ys3NG0dr.js";r.Radio.displayName="RadioGroup.Radio";const G={component:r,title:"Komponenter/RadioGroup/RadioGroup",argTypes:{classNames:{control:!1,table:{category:e.props}},children:{control:!1,table:{category:e.props}},description:{table:{category:e.props}},errorMessage:{table:{category:e.props}},hasSpacing:{table:{category:e.props}},helpSvgPath:{options:Object.keys(p),mapping:p,table:{category:e.props,defaultValue:{summary:"HelpSimpleSVGpath"}}},helpText:{control:"text",table:{category:e.props}},hideLegend:{table:{category:e.props}},legend:{control:"text",table:{category:e.props}},shadowRootNode:{control:!1,table:{category:e.props}},showRequiredMark:{table:{category:e.props}},titleHelpSvg:{table:{category:e.props,defaultValue:{summary:b()}}},variant:{table:{category:e.props,defaultValue:{summary:k()}}},defaultValue:{control:"text",table:{category:e.props}},selectedValue:{control:"text",table:{category:e.props}},disabled:{table:{category:e.htmlAttribute}},form:{table:{category:e.htmlAttribute}},name:{table:{category:e.htmlAttribute}},required:{control:"boolean",table:{category:e.htmlAttribute}},onBlur:{...d},onChange:{...d},onHelpToggle:{control:!1,table:{category:e.event}}},args:{legend:"Type virksomhet",children:[a.jsx(r.Radio,{value:"foretak",children:"Enkeltpersonsforetak"},"radio1"),a.jsx(r.Radio,{value:"selskap",children:"Aksjeselskap"},"radio2"),a.jsx(r.Radio,{value:"annet",children:"Annet"},"radio3")]}},o={},t={render:E=>{const[y,h]=n.useState("foretak"),[l,f]=n.useState(""),[S,i]=n.useState("");return a.jsxs(a.Fragment,{children:[a.jsxs(r,{legend:"Type virksomhet",selectedValue:y,required:!0,onChange:s=>h(s.target.value),children:[a.jsx(r.Radio,{value:"foretak",children:"Enkeltpersonsforetak"}),a.jsx(r.Radio,{value:"selskap",children:"Aksjeselskap"}),a.jsx(r.Radio,{value:"annet",children:"Annet"})]}),a.jsxs(r,{variant:"horizontal",legend:"Har du sendt inn skattemeldingen?",selectedValue:l,errorMessage:S,required:!0,onBlur:l?void 0:()=>i("Svar på om du har sendt inn skattemeldingen."),onChange:s=>{f(s.target.value),i("")},children:[a.jsx(r.Radio,{value:"ja",children:"Ja"}),a.jsx(r.Radio,{value:"nei",children:"Nei"})]})]})}};t.parameters=x;var u,c,g;o.parameters={...o.parameters,docs:{...(u=o.parameters)==null?void 0:u.docs,source:{originalSource:"{} satisfies Story",...(g=(c=o.parameters)==null?void 0:c.docs)==null?void 0:g.source}}};var m,v,R;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`{
...
//# sourceMappingURL=RadioGroup.stories-D9wpV-We.js.map
