import{j as e}from"./chunk-62JRHF6Z-B4JvYaBZ.js";import{e as o}from"./router-link-Bw__wKpt.js";import"./index-Dxsq0Xcr.js";import"./public-url-a6YwxxU7.js";let c={title:"CheckboxGroup",description:"CheckboxGroup brukes når brukeren kan velge ett eller flere alternativer. Hver avkrysning er uavhengig av de andre, og det er også et gyldig valg å ikke velge noen.",icon:"/illustrations/checkboxgroup.svg"},u={contents:[{heading:"bruk-checkboxgroup-når",content:"brukeren skal kunne velge mellom flere uavhengige valg"},{heading:"bruk-checkboxgroup-når",content:"det er et gyldig alternativ for brukeren å ikke krysse av noe"},{heading:"unngå-checkboxgroup-når",content:"brukeren kun skal ta ett valg blant flere. Bruk RadioGroup i stedet."},{heading:"hvorfor-vi-anbefaler-dette",content:"Grupperingen med ledetekst (`legend`-element) sørger for at skjermlesere forstår at valgene hører til samme spørsmål. Uten dette leses hvert enkelt valg opp uten kontekst."},{heading:"hvorfor-vi-anbefaler-dette",content:"Vertikal visning er standard fordi den gir bedre lesbarhet og fungerer bedre på tvers av skjermstørrelser. Mange alternativer på én linje kan være vanskelig å lese, særlig på små skjermer."},{heading:"hvorfor-vi-anbefaler-dette",content:"Det skal være mulig å ikke velge noe. Ikke alle brukere har nødvendigvis et alternativ som passer, og tvungne valg kan føre til feil data."},{heading:"plassering-og-justering",content:"Alle checkboxer i gruppen skal plasseres vertikalt"},{heading:"plassering-og-justering",content:"Det skal være mulig å velge null, ett eller flere alternativer."},{heading:"interaksjon-og-tilstander",content:"Alle valg er uavhengige av hverandre — avkrysning i én boks påvirker ikke de andre."},{heading:"interaksjon-og-tilstander",content:"CheckboxGroup må alltid inneholde underkomponenter (children)."},{heading:"tekst",content:`Spørsmål eller ledetekst for gruppen skal stå i et legend‑element.\\
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["brukeren kun skal ta ett valg blant flere. Bruk ",e.jsx(n.a,{href:"/byggeklosser/komponenter/radiogroup",children:"RadioGroup"})," i stedet."]}),`
`]}),`
...
`,e.jsx(n.li,{children:"Vertikal visning er standard fordi den gir bedre lesbarhet og fungerer bedre på tvers av skjermstørrelser. Mange alternativer på én linje kan være vanskelig å lese, særlig på små skjermer."}),`
`,e.jsx(n.li,{children:"Det skal være mulig å ikke velge noe. Ikke alle brukere har nødvendigvis et alternativ som passer, og tvungne valg kan føre til feil data."}),`
`]}),`
...
`,e.jsx(n.li,{children:"CheckboxGroup må alltid inneholde underkomponenter (children)."}),`
`]}),`
`,e.jsx(n.h2,{id:"tekst",children:"Tekst"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Spørsmål eller ",e.jsx(s,{wordInfoKey:"ledetekst",children:"ledetekst"})," for gruppen skal stå i et legend‑element.",e.jsx(n.br,{}),`
...
`,e.jsx(t,{of:o.Checkbox})]})}function v(r={}){const{wrapper:n}=r.components||{};return n?e.jsx(n,{...r,children:e.jsx(a,{...r})}):a(r)}function l(r,n){throw new Error("Expected component `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}export{v as default,c as frontmatter,u as structuredData,p as toc};
