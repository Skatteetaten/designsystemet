import{j as t}from"./iframe-_BeEUj9n.js";import{H as p}from"./index-Bva6C3l7.js";import{T as n}from"./index-BUfGp1h_.js";import{S as h}from"./icon.systems-C7aKoqez.js";import{l as v}from"./storybook.testing.utils-BgHZnMzD.js";const{expect:s,within:b}=__STORYBOOK_MODULE_TEST__,T={component:n,title:"Tester/Tag",argTypes:{ref:{table:{disable:!0}},className:{table:{disable:!0}},id:{table:{disable:!0}},lang:{table:{disable:!0}},"data-testid":{table:{disable:!0}},canBeManuallyFocused:{table:{disable:!0}},children:{table:{disable:!0},control:"text"},svgPath:{table:{disable:!0},options:Object.keys(h),mapping:h},color:{table:{disable:!0}},size:{table:{disable:!0}}},tags:["test"],parameters:{imageSnapshot:{disableSnapshot:!1}}},y="Særavgift",r={children:y},o={name:"With Ref (FA1)",args:{...r,ref:a=>{a&&(a.id="dummyIdForwardedFromRef")}},argTypes:{ref:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:a})=>{const e=b(a).getAllByRole("generic")[1];await s(e).toHaveAttribute("id","dummyIdForwardedFromRef")}},l={name:"With Attributes (FA2-5)",args:{...r,id:"htmlId",className:"dummyClassname",lang:"en","data-testid":"123ID"},argTypes:{id:{table:{disable:!1}},className:{table:{disable:!1}},lang:{table:{disable:!1}},"data-testid":{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0},a11y:{test:"off"}},play:async({canvasElement:a})=>{const e=b(a).getAllByRole("generic")[1];await s(e).toHaveAttribute("id","htmlId"),await s(e).toHaveClass("dummyClassname"),await s(e).toHaveAttribute("lang","en"),await s(e).toHaveAttribute("data-testid","123ID")}},i={name:"Default Variant (ochre) (A3)",args:{...r},argTypes:{color:{table:{disable:!1}}}},c={name:"All color variants (A3)",args:{...r},render:({children:a})=>t.jsxs(t.Fragment,{children:[t.jsx(n,{color:"ochre",children:a}),t.jsx(n,{color:"forest",children:a}),t.jsx(n,{color:"burgundy",children:a}),t.jsx(n,{color:"graphite",children:a}),t.jsx(n,{color:"denim",children:a}),t.jsx(n,{color:"white",children:a})]})},d={name:"Small (A1)",args:{...r,size:"small"},argTypes:{size:{table:{disable:!1}}}},m={name:"With Custom Icon (A5)",args:{...r,svgPath:p,color:"burgundy"},argTypes:{svgPath:{table:{disable:!1}}}},g={args:{...r,svgPath:p,canBeManuallyFocused:!0},argTypes:{canBeManuallyFocused:{table:{disable:!1}}},play:async({canvasElement:a})=>{const e=b(a).getByText(y);e.focus(),await s(e).toBeInTheDocument(),await s(e).toHaveAttribute("tabIndex","-1")}},u={name:"With Icon and Long Text",args:{children:v,svgPath:p},argTypes:{svgPath:{table:{disable:!1}}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  name: 'With Ref (FA1)',
  args: {
    ...defaultArgs,
...
} satisfies Story`,...u.parameters?.docs?.source}}};const A=["WithRef","WithAttributes","DefaultYellow","AllVariants","Small","WithCustomIcon","WithCanBeManuallyFocused","WithIconAndLongText"],F=Object.freeze(Object.defineProperty({__proto__:null,AllVariants:c,DefaultYellow:i,Small:d,WithAttributes:l,WithCanBeManuallyFocused:g,WithCustomIcon:m,WithIconAndLongText:u,WithRef:o,__namedExportsOrder:A,default:T},Symbol.toStringTag,{value:"Module"}));export{F as T};
//# sourceMappingURL=Tag.test.stories-D-pltibw.js.map
