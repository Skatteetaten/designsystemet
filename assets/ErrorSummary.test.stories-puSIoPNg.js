import{j as n,r as x}from"./iframe-DyzX2HZk.js";import{B as R}from"./index-tiKhdOIe.js";import{E as o}from"./index-BsMkEDp2.js";import{P as S}from"./index-CMkU_MzX.js";import{l as A}from"./storybook.testing.utils-BgHZnMzD.js";import{w as W}from"./webcomponent-decorator-Bol-bNci.js";import{T as E}from"./DatePickerCalendar-CpbLitON.js";const{expect:r,userEvent:I,waitFor:B,within:i}=__STORYBOOK_MODULE_TEST__,C={component:o,title:"Tester/ErrorSummary",argTypes:{ref:{table:{disable:!0}},className:{table:{disable:!0}},id:{table:{disable:!0}},lang:{table:{disable:!0}},"data-testid":{table:{disable:!0}},children:{table:{disable:!0},control:{disable:!0}},content:{table:{disable:!0},control:{disable:!0}},hasSpacing:{table:{disable:!0}},shadowRootNode:{table:{disable:!0}},showErrorSummary:{table:{disable:!0}},title:{table:{disable:!0}},titleAs:{control:"inline-radio",table:{disable:!0}}},tags:["test"]},f=[n.jsx(o.Error,{referenceId:"id_1",children:"Husk å fylle ut type varer"},"errorSummaryError_1"),n.jsx(o.Error,{referenceId:"id_2",children:"Selger du varer og tjenester for egen regning?"},"errorSummaryError_2"),!1],l={name:"With Ref (FA1)",args:{ref:t=>{t&&(t.id="dummyIdForwardedFromRef")}},argTypes:{ref:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:t})=>{const e=i(t).getAllByRole("generic")[1];await r(e).toHaveAttribute("id","dummyIdForwardedFromRef")}},c={name:"With Attributes (FA2-5, B1)",args:{id:"htmlId",className:"dummyClassname",lang:"nb","data-testid":"123ID",showErrorSummary:!0},argTypes:{id:{table:{disable:!1}},className:{table:{disable:!1}},lang:{table:{disable:!1}},"data-testid":{table:{disable:!1}}},parameters:{a11y:{test:"off"}},play:async({canvasElement:t})=>{const a=i(t),e=a.getAllByRole("generic")[1],s=a.getAllByRole("generic")[2];await r(e).toHaveAttribute("id","htmlId"),await r(s).toHaveClass("dummyClassname"),await r(e).toHaveAttribute("lang","nb"),await r(e).toHaveAttribute("data-testid","123ID")}},m={name:"Default (B2, B3 delvis)",play:async({canvasElement:t})=>{const e=i(t).getAllByRole("generic")[1];await r(e).toBeInTheDocument(),await r(e).toHaveAttribute("tabIndex","-1");const s=e.querySelector("div");await r(s).not.toBeInTheDocument()}},d={name:"With Children (A1, A2, A3 delvis)",args:{showErrorSummary:!0,children:f},argTypes:{children:{table:{disable:!1}}},play:async({canvasElement:t})=>{const e=i(t).getAllByRole("listitem");await r(e).toHaveLength(2)}},u={name:"With Content (A1, A5, B1)",args:{showErrorSummary:!0,title:"Inntektsmottaker inneholder 2 feil:",content:n.jsx(S,{children:A})},argTypes:{content:{table:{disable:!1}},title:{table:{disable:!1}}},play:async({canvasElement:t})=>{const e=i(t).getByRole("img",{hidden:!0});await r(e).toBeInTheDocument(),await r(e).toHaveAttribute("aria-hidden","true")}},h={name:"With Children And Content (A1, A3 delvis, A5)",args:{showErrorSummary:!0,children:f,content:n.jsx(S,{children:A})},argTypes:{children:{table:{disable:!1}},content:{table:{disable:!1}}}},p={name:"With Children And Content Mobile",args:{showErrorSummary:!0,children:f,content:n.jsx(S,{children:A})},argTypes:{children:{table:{disable:!1}},content:{table:{disable:!1}}},globals:{viewport:{value:"--mobile"}}},y={name:"With Children And Content Breakpoint Xs",args:{showErrorSummary:!0,children:f,content:n.jsx(S,{children:A})},argTypes:{children:{table:{disable:!1}},content:{table:{disable:!1}}},globals:{viewport:{value:"--breakpoint-xs"}}},b={name:"With TitleAs (A2)",args:{showErrorSummary:!0,titleAs:"h1",children:f},argTypes:{titleAs:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:t})=>{const e=i(t).getByRole("heading",{level:1});await r(e).toBeInTheDocument()}},k=()=>n.jsxs(n.Fragment,{children:[n.jsx(E,{id:"input_aar",label:"År",value:1009,errorMessage:"Inntekståret må være etter 2008",hasSpacing:!0,required:!0}),n.jsx(o,{showErrorSummary:!0,children:n.jsx(o.Error,{referenceId:"input_aar",children:"Inntekståret må være etter 2008"})})]}),g={render:k,name:"With Input (A4)",play:async({canvasElement:t})=>{const a=i(t),e=a.getByRole("link"),s=a.getByLabelText("År");await I.click(e),await B(()=>r(s).toHaveFocus())}},D=()=>{const a=document.querySelector("errorsummary-customelement")?.shadowRoot;return n.jsxs("div",{"data-test-block":!0,children:[n.jsx(E,{id:"input_aar",label:"År",value:1009,errorMessage:"Inntekståret må være etter 2008",hasSpacing:!0,required:!0}),n.jsx(o,{shadowRootNode:a??void 0,showErrorSummary:!0,children:n.jsx(o.Error,{referenceId:"input_aar",children:"Inntekståret må være etter 2008"})})]})},v={render:D,name:"With ShadowRootNode",decorators:[W],parameters:{a11y:{disable:!0},imageSnapshot:{disableSnapshot:!0},customElementName:"errorsummary-customelement"},play:async({canvasElement:t})=>{const a=i(t);await r(a.queryByRole("link")).not.toBeInTheDocument();const e=t.querySelector("errorsummary-customelement");await r(e).toBeInTheDocument();const s=e?.shadowRoot&&e.shadowRoot.querySelector("a");await r(s).toBeInTheDocument(),await I.click(s);const T=e?.shadowRoot&&e.shadowRoot.querySelector("input:focus");await r(T).toBeInTheDocument()}},F=()=>{const[t,a]=x.useState({hasError:!1});return n.jsxs(n.Fragment,{children:[n.jsx(E,{id:"input_aar",label:"År",value:1009,errorMessage:"Inntekståret må være etter 2008",hasSpacing:!0,required:!0}),n.jsx(o,{id:"errorSummary1",showErrorSummary:t.hasError,hasSpacing:!0,children:n.jsx(o.Error,{referenceId:"input_aar",children:"Inntekståret må være etter 2008"})}),n.jsx(R,{onClick:()=>{a({hasError:!t.hasError}),setTimeout(()=>{document.getElementById("errorSummary1")?.focus()},0)},children:"Send"})]})},w={render:F,name:"With Focus",play:async({canvasElement:t})=>{const a=i(t),e=a.getByRole("button");await I.click(e);const s=a.getAllByRole("generic")[4];await B(()=>r(s).toHaveFocus())}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  name: 'With Ref (FA1)',
  args: {
...
} satisfies Story`,...w.parameters?.docs?.source}}};const j=["WithRef","WithAttributes","Defaults","WithChildren","WithContent","WithChildrenAndContent","WithChildrenAndContentMobile","WithChildrenAndContentBreakpointXs","WithTitleAs","WithInput","WithShadowRootNode","WithFocus"],O=Object.freeze(Object.defineProperty({__proto__:null,Defaults:m,WithAttributes:c,WithChildren:d,WithChildrenAndContent:h,WithChildrenAndContentBreakpointXs:y,WithChildrenAndContentMobile:p,WithContent:u,WithFocus:w,WithInput:g,WithRef:l,WithShadowRootNode:v,WithTitleAs:b,__namedExportsOrder:j,default:C},Symbol.toStringTag,{value:"Module"}));export{O as E};
//# sourceMappingURL=ErrorSummary.test.stories-puSIoPNg.js.map
