import{c as e,r as h,j as r,b as m}from"./iframe-BQX7p2fO.js";import{B as k}from"./index-ZQJoFOIZ.js";import{a as t}from"./index-Dz9Mp0Gs.js";import{S as p}from"./icon.systems-WAvM-z7u.js";import{e as u}from"./stories.utils-B3vRc2tk.js";t.Checkbox.displayName="CheckboxGroup.Checkbox";const x={component:t,title:"Komponenter/CheckboxGroup",argTypes:{children:{control:!1,table:{category:e.props}},classNames:{control:!1,table:{category:e.props}},description:{table:{category:e.props}},errorMessage:{table:{category:e.props}},hasSpacing:{table:{category:e.props}},helpSvgPath:{options:Object.keys(p),mapping:p,table:{category:e.props,defaultValue:{summary:"HelpSimpleSVGpath"}}},helpText:{control:"text",table:{category:e.props}},hideLegend:{table:{category:e.props}},legend:{control:"text",table:{category:e.props}},readOnly:{table:{category:e.props}},showRequiredMark:{table:{category:e.props},description:'Om obligatorisk gruppe skal markeres med stjerne. <strong>Deprecated:</strong> Prop skal fjernes ved lansering av neste major versjon. Les mer om mønstre for obligatoriske felt på <a href="https://www.skatteetaten.no/stilogtone/monster/interaksjon/obligatoriske-felt/">stil og tone</a>.'},titleHelpSvg:{table:{category:e.props,defaultValue:{summary:m()}}},disabled:{table:{category:e.htmlAttribute}},form:{table:{category:e.htmlAttribute}},ariaDescribedBy:{table:{category:e.aria}},onHelpToggle:{control:!1,table:{category:e.event}}},args:{children:[r.jsx(t.Checkbox,{children:"Har barn over 16 år"},"checkbox1"),r.jsx(t.Checkbox,{children:"Har barn under 12 år"},"checkbox2"),r.jsx(t.Checkbox,{children:"Har ingen barn"},"checkbox3")],legend:"Velg det som passer deg"}},s={},o={render:f=>{const l=[{label:"Har barn over 16 år"},{label:"Har barn under 12 år"},{label:"Får ekstra reisevei til jobb på grunn av levering til barnehage eller skolefritidsordning"},{label:"Har barn som er 12 år eller eldre og som har særskilt omsorgsbehov"},{label:"Er enslig forsørger"}],[c,d]=h.useState(new Array(l.length).fill(!1)),g=n=>{const a=c.map((i,b)=>b===n?!i:i);d(a)};return r.jsxs(r.Fragment,{children:[r.jsx(t,{legend:"Velg det som gjelder deg",children:l.map((n,a)=>r.jsx(t.Checkbox,{checked:c[a],onChange:()=>g(a),children:n.label},a))}),r.jsx(k,{children:"Neste side"})]})}};o.parameters=u;s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"{} satisfies Story",...s.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
...
} satisfies Story`,...o.parameters?.docs?.source}}};const y=["Preview","Examples"],G=Object.freeze(Object.defineProperty({__proto__:null,Examples:o,Preview:s,__namedExportsOrder:y,default:x},Symbol.toStringTag,{value:"Module"}));export{G as C,o as E};
//# sourceMappingURL=CheckboxGroup.stories-Dl3HcsKt.js.map
