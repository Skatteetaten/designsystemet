...
`})}),`
`,e.jsx(n.p,{children:"Denne strukturen sikrer at feilmeldinger vises korrekt med filene de gjelder for."})]})}function m(r={}){const{wrapper:n}={...i(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(s,{...r})}):s(r)}export{m as default};
//# sourceMappingURL=useFileUploader-JkJTcd-r.js.map
