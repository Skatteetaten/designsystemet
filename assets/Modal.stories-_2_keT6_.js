import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{r as o}from"./index-7h80QhK_.js";import{B as a}from"./index-TStLVSlm.js";import{s as A,d as k,u as F}from"./index-EsEcB_zD.js";import{R as y}from"./index-DmQJLmMR.js";import{g as _,U as G}from"./index-MCo35TjR.js";import{g as O,a as H,b as X,c as z,M as v}from"./index-w6speL5o.js";import{P as u,L as x}from"./index-SYCMKRjb.js";import{c as t}from"./helpers-BRYKCfPN.js";import{f as J,w as W}from"./wait-alert-illustration-CKfOc_iA.js";import{l as U}from"./storybook.testing.utils-CMs160i9.js";import{e as M}from"./stories.utils-Ys3NG0dr.js";const Q={component:v,title:"Komponenter/Modal",argTypes:{children:{control:"text",table:{category:t.props}},classNames:{control:{disable:!0},table:{category:t.props}},dismissOnEsc:{table:{category:t.props,defaultValue:{summary:z().toString()}}},dismissOnOutsideClick:{table:{category:t.props,defaultValue:{summary:X().toString()}}},hideCloseButton:{table:{category:t.props}},hideTitle:{table:{category:t.props}},imageSource:{table:{category:t.props},control:"select",options:["",J,W]},imageSourceAltText:{table:{category:t.props}},padding:{table:{category:t.props,defaultValue:{summary:H()}}},renderIcon:{table:{category:t.props},control:"select",options:["","Icon","Logo"],mapping:{"":"",Icon:()=>e.jsx(_,{size:"extraLarge"}),Logo:()=>e.jsx("img",{src:A,alt:"Skatteetaten logo",className:"logo"})}},shadowRootNode:{control:!1,table:{control:!1,category:t.props}},title:{table:{category:t.props}},variant:{table:{category:t.props,defaultValue:{summary:O()}}},onClose:{control:{disable:!0},table:{category:t.event}}},args:{children:e.jsx(u,{children:U}),title:"Modal title"}},h={render:g=>{const s=o.useRef(null);return e.jsxs(e.Fragment,{children:[e.jsx(a,{onClick:()=>{var n;return(n=s.current)==null?void 0:n.showModal()},children:"Åpne modal"}),e.jsx(v,{...g,ref:s,children:g.children})]})}},d={render:g=>{const s=o.useRef(null);return e.jsxs(e.Fragment,{children:[e.jsx(a,{onClick:()=>{var n;return(n=s.current)==null?void 0:n.showModal()},children:"Nye opplysninger"}),e.jsxs(v,{ref:s,title:"Vil du erstatte nye opplysninger fra fil?",children:[e.jsx(u,{hasSpacing:!0,children:"Du har valgt å laste opp nye opplysninger fra fil. Vil du at disse skal gjelde fra nå av?"}),e.jsxs("div",{className:"flex",children:[e.jsx(a,{className:"marginRightM",children:"Erstatt opplysninger"}),e.jsx(a,{variant:"tertiary",onClick:()=>{var n;return(n=s.current)==null?void 0:n.close()},children:"Avbryt"})]})]})]})}};d.parameters=M;const c={render:function(s){const n=o.useRef(null),[p,i]=o.useState(12e5),S=o.useRef(new Date().getTime()),f=()=>{S.current=new Date().getTime()},j=()=>{var r;(r=n.current)==null||r.close(),f()};return o.useEffect(()=>{const l=setInterval(()=>{var b;new Date().getTime()-S.current>=p&&((b=n.current)==null||b.showModal())},1e3);return()=>clearInterval(l)},[p]),o.useEffect(()=>{const r=new AbortController,{signal:l}=r;return window.addEventListener("keydown",f,{signal:l}),window.addEventListener("mousemove",f,{signal:l}),window.addEventListener("scroll",f,{signal:l}),window.addEventListener("resize",f,{signal:l}),()=>{r.abort()}},[]),e.jsxs(e.Fragment,{children:[e.jsx(a,{variant:"secondary",className:"bottomSpacingXL",onClick:()=>{var r;return(r=n.current)==null?void 0:r.showModal()},children:"Vis ventevarsel"}),e.jsxs(y,{legend:"Ventevarseleksempel åpnes automatisk etter",helpText:"Hver gang du beveger musepekeren, scroller eller gjør et tastetrykk, resettes timeren.",selectedValue:p,onChange:r=>i(Number(r.target.value)),children:[e.jsx(y.Radio,{value:12e5,children:"20 minutter (anbefalt i løsninger)"}),e.jsx(y.Radio,{value:5e3,children:"5 sekunder"})]}),e.jsxs(v,{ref:n,title:k.t("ds_overlays:modal.WaitNoticeTitle"),imageSource:W,imageSourceAltText:k.t("ds_overlays:modal.WaitNoticeImageAltText"),onClose:j,children:[e.jsx(u,{hasSpacing:!0,children:k.t("ds_overlays:modal.WaitNoticeParagraph")}),e.jsx(a,{onClick:()=>{j()},children:k.t("ds_overlays:modal.StayLoggedIn")})]})]})}};c.parameters=M;const m={render:function(s){const n=o.useRef(null),p=F("(min-width: 640px)");return e.jsxs(e.Fragment,{children:[e.jsx(a,{variant:"danger",onClick:()=>{var i;return(i=n.current)==null?void 0:i.showModal()},children:"Åpne feilmeldingsmodal"}),e.jsxs(v,{ref:n,title:"Beklager, noe gikk galt",padding:p?"mega":"m",renderIcon:()=>e.jsx(_,{size:"extraLarge"}),children:[e.jsx(u,{hasSpacing:!0,children:"Vi klarte ikke å hente skjemet akkurat nå."}),e.jsx(u,{className:"bold",children:"Du kan prøve å"}),e.jsxs(x,{hasSpacing:!0,children:[e.jsxs(x.Element,{children:["vente noen minutter og ",e.jsx("a",{href:"#link",children:"laste inn siden på nytt"})]}),e.jsx(x.Element,{children:e.jsx("a",{href:"#link",children:"gå tilbake til forrige side"})})]}),e.jsxs(u,{hasSpacing:!0,children:["Hvis du fortsatt har problemer kan du ",e.jsx("a",{href:"#link",children:"kontakte oss"})]}),e.jsx(a,{className:"exampleSpacing",svgPath:G,onClick:()=>{var i;return(i=n.current)==null?void 0:i.close()},children:"Last inn siden på nytt"}),e.jsx(a,{variant:"secondary",href:"#",children:"Gå til forsiden"})]})]})}};m.parameters=M;var w,E,T;h.parameters={...h.parameters,docs:{...(w=h.parameters)==null?void 0:w.docs,source:{originalSource:`{
...
} satisfies Story`,...(V=(N=m.parameters)==null?void 0:N.docs)==null?void 0:V.source}}};const K=["Preview","Samtykkemodal","Ventevarsel","Feilmeldingsmodal"],de=Object.freeze(Object.defineProperty({__proto__:null,Feilmeldingsmodal:m,Preview:h,Samtykkemodal:d,Ventevarsel:c,__namedExportsOrder:K,default:Q},Symbol.toStringTag,{value:"Module"}));export{m as F,de as M,d as S,c as V};
//# sourceMappingURL=Modal.stories-_2_keT6_.js.map
