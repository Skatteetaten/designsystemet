import{j as e}from"./jsx-runtime-Nms4Y4qS.js";import{r as i}from"./index-BwDkhjyp.js";import{B as n,b as j}from"./index-CKHxS2Ra.js";import{R as c}from"./index-Be268C4q.js";import{h as f}from"./index-C3Vp3Ydz.js";import{M as l,g as S,a as b,b as C,c as V}from"./index-BFMd1xC6.js";import{P as p}from"./index-DWqb7jS3.js";import{c as a}from"./helpers-Dccz2jQ-.js";import{f as B,w as R}from"./wait-alert-illustration-BZ1f2OL4.js";import{l as I}from"./storybook.testing.utils-CMs160i9.js";import{e as N}from"./stories.utils-Ys3NG0dr.js";const E={component:l,title:"Komponenter/Modal",argTypes:{children:{control:{disable:!0},table:{category:a.props}},classNames:{control:{disable:!0},table:{category:a.props}},dismissOnEsc:{table:{category:a.props,defaultValue:{summary:S().toString()}}},dismissOnOutsideClick:{table:{category:a.props,defaultValue:{summary:b().toString()}}},hideCloseButton:{table:{category:a.props}},hideTitle:{table:{category:a.props}},imageSource:{table:{category:a.props},control:"select",options:["",B,R]},imageSourceAltText:{table:{category:a.props}},padding:{table:{category:a.props,defaultValue:{summary:C()}}},shadowRootNode:{control:!1,table:{control:!1,category:a.props}},title:{table:{category:a.props}},variant:{table:{category:a.props,defaultValue:{summary:V()}}},onClose:{control:{disable:!0},table:{category:a.event}}},args:{children:e.jsx(p,{children:I}),title:"Modal title"}},d={render:u=>{const t=i.useRef(null);return e.jsxs(e.Fragment,{children:[e.jsx(n,{onClick:()=>{var o;return(o=t.current)==null?void 0:o.showModal()},children:"Åpne modal"}),e.jsx(l,{...u,ref:t,children:u.children})]})}},s={render:u=>{const t=i.useRef(null),o=i.useRef(null),m=i.useRef(null),g=i.useRef(null);return e.jsxs(e.Fragment,{children:[e.jsx(n,{className:"exampleSpacing",onClick:()=>{var r;return(r=t.current)==null?void 0:r.showModal()},children:"Nye opplysninger"}),e.jsxs(l,{ref:t,title:"Vil du erstatte nye opplysninger fra fil?",children:[e.jsx(p,{hasSpacing:!0,children:"Du har valgt å laste opp nye opplysninger fra fil. Vil du at disse skal gjelde fra nå av?"}),e.jsxs("div",{className:"flex",children:[e.jsx(n,{className:"marginRightM",children:"Erstatt opplysninger"}),e.jsx(n,{variant:"tertiary",onClick:()=>{var r;return(r=t.current)==null?void 0:r.close()},children:"Avbryt"})]})]}),e.jsx(n,{className:"exampleSpacing",onClick:()=>{var r;return(r=o.current)==null?void 0:r.showModal()},children:"Velg rolle"}),e.jsxs(l,{ref:o,title:"Dette er dine roller",onClose:()=>{console.log("lukker mod2")},children:[e.jsxs(c,{legend:"Velge en rolle",children:[e.jsx(c.Radio,{value:"meg",children:"Innlogget som meg selv"}),e.jsx(c.Radio,{value:"andre",children:"Innlogget som annen person"}),e.jsx(c.Radio,{value:"virksomhet",children:"Innlogget som virksomhet"})]}),e.jsx(n,{onClick:()=>{var r;return(r=o.current)==null?void 0:r.close()},children:"Ok"})]}),e.jsx(n,{className:"exampleSpacing",variant:"tertiary",svgPath:f,onClick:()=>{var r;return(r=m.current)==null?void 0:r.showModal()},children:"Viktig driftsmelding"}),e.jsxs(l,{ref:m,variant:"important",title:"Viktig melding!",children:[e.jsx(p,{hasSpacing:!0,children:"Løsningen er ikke kommet i drift ennå eller tatt ned for vedlikehold."}),e.jsx("div",{className:"modalLink",children:e.jsx(j,{href:"#",onClick:()=>{var r;return(r=m.current)==null?void 0:r.close()},children:"Les mer på skatteetaten.no"})})]}),e.jsx(n,{className:"exampleSpacing",variant:"tertiary",svgPath:f,onClick:()=>{var r;return(r=g.current)==null?void 0:r.showModal()},children:"Vis ventevarsel"}),e.jsxs(l,{ref:g,title:"Hei, er du fortsatt her?",imageSource:R,imageSourceAltText:"Illustrasjon av travel person med seks armer, opptatt med kontorarbeid.",children:[e.jsx(p,{hasSpacing:!0,children:"Vi ser at du ikke har gjort noe på nettsiden på ei stund. Er du fortsatt her?"}),e.jsx(n,{className:"width100",onClick:()=>{var r;return(r=g.current)==null?void 0:r.close()},children:"Ja"})]})]})}};s.parameters=N;var h,v,k;d.parameters={...d.parameters,docs:{...(h=d.parameters)==null?void 0:h.docs,source:{originalSource:`{
...
} satisfies Story`,...(y=(x=s.parameters)==null?void 0:x.docs)==null?void 0:y.source}}};const w=["Preview","Examples"],F=Object.freeze(Object.defineProperty({__proto__:null,Examples:s,Preview:d,__namedExportsOrder:w,default:E},Symbol.toStringTag,{value:"Module"}));export{s as E,F as M};
//# sourceMappingURL=Modal.stories-BMalQTrQ.js.map
