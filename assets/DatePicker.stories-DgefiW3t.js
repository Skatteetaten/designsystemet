import{c as e,h as b,r as d,j as c,e as x,f as M,i as P,b as V}from"./iframe-BQX7p2fO.js";import{D,b as j,g as O,c as E,f}from"./index-Dz9Mp0Gs.js";import{S as k}from"./icon.systems-WAvM-z7u.js";import{e as y}from"./stories.utils-B3vRc2tk.js";import{i as _}from"./DatePickerCalendar-CGOdmsOV.js";const{useArgs:w}=__STORYBOOK_MODULE_PREVIEW_API__,A={component:D,title:"Komponenter/DatePicker",argTypes:{classNames:{control:!1,table:{category:e.props}},value:{table:{category:e.props},control:"date"},description:{table:{category:e.props}},dateFormat:{table:{category:e.props,defaultValue:{summary:E()}}},label:{table:{category:e.props}},disabledDates:{table:{category:e.props}},errorMessage:{table:{category:e.props}},hasSpacing:{table:{category:e.props}},helpSvgPath:{options:Object.keys(k),mapping:k,table:{category:e.props,defaultValue:{summary:"HelpSimpleSVGpath"}}},helpText:{control:"text",table:{category:e.props}},hideLabel:{table:{category:e.props}},initialPickerDate:{table:{category:e.props},control:"date"},minDate:{table:{category:e.props},control:"date"},maxDate:{table:{category:e.props},control:"date"},showRequiredMark:{table:{category:e.props},description:'Om obligatorisk skjemafelt skal markeres med stjerne. Forutsetter at required er tatt i bruk. <strong>Deprecated:</strong> Prop skal fjernes ved lansering av neste major versjon. Les mer om mønstre for obligatoriske felt på <a href="https://www.skatteetaten.no/stilogtone/monster/interaksjon/obligatoriske-felt/">stil og tone</a>.'},titleHelpSvg:{table:{category:e.props,defaultValue:{summary:V()}}},variant:{control:"inline-radio",table:{category:e.props,defaultValue:{summary:P()}}},autoComplete:{table:{category:e.htmlAttribute,defaultValue:{summary:M()},type:{summary:"string"}},type:"string",description:x()},disabled:{table:{category:e.htmlAttribute}},name:{table:{category:e.htmlAttribute}},placeholder:{table:{category:e.htmlAttribute,defaultValue:{summary:O()}}},readOnly:{table:{category:e.htmlAttribute}},required:{control:"boolean",table:{category:e.htmlAttribute}},ariaDescribedBy:{table:{category:e.aria}},onBlur:{...b},onChange:{...b},onFocus:{...b},onCalendarToggle:{table:{category:e.event}},onHelpToggle:{table:{category:e.event}},onSelectDate:{table:{category:e.event}}},args:{label:"Fødselsdato"}},p={tags:["!dev"],render:t=>{const[,n]=w();t.value=t.value?new Date(t.value):null,t.minDate=t.minDate===void 0?void 0:new Date(t.minDate),t.maxDate=t.maxDate===void 0?void 0:new Date(t.maxDate),t.initialPickerDate=t.initialPickerDate===void 0?void 0:new Date(t.initialPickerDate);const o=s=>{t.onSelectDate?.(s),n({value:s})};return c.jsx(D,{...t,onSelectDate:o})}},i={render:t=>{const[n,o]=d.useState(null);return c.jsx(D,{label:"Dato (dd.mm.åååå)",value:n,required:!0,onSelectDate:o})}};i.parameters=y;const m={name:"Med min- og maxdato",render:t=>{const[n,o]=d.useState(null),[s,v]=d.useState(""),[S,a]=d.useState(""),r=new Date(2024,6,1),l=new Date(2024,12,1),h=g=>{g===null?a(s!==""?"Datoen har ikke rett format. Skriv slik: 17.05.2024.":"Dato må fylles ut eller velges."):_(g,{start:r,end:l})?a(""):a(`Dato må være mellom ${f(r,"dd.MM.yyyy")} og ${f(l,"dd.MM.yyyy")}.`),o(g)};return c.jsx(D,{label:"Oppstartsdato (dd.mm.åååå)",value:n,errorMessage:S,maxDate:l,minDate:r,hasSpacing:!0,required:!0,onSelectDate:h,onChange:g=>v(g.target.value)})}};m.parameters=y;const u={name:"Dato og klokkeslett",render:t=>{const[n,o]=d.useState(null),[s,v]=d.useState(""),S=[];for(let a=8;a<=16;a++)for(let r=0;r<60&&!(a===16&&r>0);r+=30){const l=`${a.toString().padStart(2,"0")}:${r.toString().padStart(2,"0")}`;S.push({value:l,label:l})}return c.jsxs("div",{className:"flex gapM",children:[c.jsx(D,{label:"Dato (dd.mm.åååå)",value:n,onSelectDate:o}),c.jsx(j,{label:"Tid (tt:mm)",value:s,options:S,placeholder:"",className:"textField150",onSelectionChange:a=>v(a?.value??"")})]})}};u.parameters=y;p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  tags: ['!dev'],
...
//# sourceMappingURL=DatePicker.stories-DgefiW3t.js.map
