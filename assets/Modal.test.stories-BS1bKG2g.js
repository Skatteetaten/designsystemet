    ...
    viewport: {
      options: {
        maxHeight: {
          name: 'maxHeight',
          styles: {
            width: breakpoints['--breakpoint-m'],
            height: '500px'
          }
        }
      }
...
} satisfies Story`,...D.parameters?.docs?.source}}};N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
  render: TemplateModal,
  name: 'On Mobile',
  args: {},
  globals: {
...
} satisfies Story`,...N.parameters?.docs?.source}}};const Ve=["WithAttributes","Defaults","VariantPlain","WithImage","WithIcon","WithTransparentBackground","WithoutCloseButton","WithPadding","WithVerticalScrolling","ClickCloseButton","WithAutoClose","WithAutoCloseDisabled","WithHideTitle","WithShadowDom","WithStateChangeAndFocus","WithStateChangeAndTextFieldFocus","AutoOpen","AutoOpenAndCloseOnEscape","AutoOpenAndCloseOnUserInput","WithFormValidationFocusRetention","MinimumWidth","OnMobile"];export{I as AutoOpen,W as AutoOpenAndCloseOnEscape,M as AutoOpenAndCloseOnUserInput,E as ClickCloseButton,y as Defaults,D as MinimumWidth,N as OnMobile,v as VariantPlain,b as WithAttributes,S as WithAutoClose,C as WithAutoCloseDisabled,F as WithFormValidationFocusRetention,R as WithHideTitle,B as WithIcon,w as WithImage,x as WithPadding,A as WithShadowDom,O as WithStateChangeAndFocus,j as WithStateChangeAndTextFieldFocus,k as WithTransparentBackground,T as WithVerticalScrolling,f as WithoutCloseButton,Ve as __namedExportsOrder,Pe as default};
//# sourceMappingURL=Modal.test.stories-BS1bKG2g.js.map
