import{j as o,r as $}from"./iframe-DyzX2HZk.js";import"./index-BsMkEDp2.js";import{A as z}from"./index-BVZq6FY6.js";import{w as I}from"./storybook.testing.utils-BgHZnMzD.js";import{S as q}from"./icon.systems-CftjSuGj.js";import{S as l,g as G}from"./DatePickerCalendar-CpbLitON.js";const{expect:t,fireEvent:J,fn:V,userEvent:j,waitFor:P,within:i}=__STORYBOOK_MODULE_TEST__,K={component:l,title:"Tester/Select",argTypes:{ref:{table:{disable:!0}},className:{table:{disable:!0}},id:{table:{disable:!0}},lang:{table:{disable:!0}},"data-testid":{table:{disable:!0}},children:{table:{disable:!0}},classNames:{table:{disable:!0}},defaultValue:{table:{disable:!0}},value:{table:{disable:!0}},placeholder:{table:{disable:!0}},description:{table:{disable:!0}},errorMessage:{table:{disable:!0}},hasSpacing:{table:{disable:!0}},helpSvgPath:{table:{disable:!0},options:Object.keys(q),mapping:q},helpText:{table:{disable:!0}},hideLabel:{table:{disable:!0}},hidePlaceholder:{table:{disable:!0}},variant:{table:{disable:!0},control:"inline-radio"},label:{table:{disable:!0}},showRequiredMark:{table:{disable:!0}},titleHelpSvg:{table:{disable:!0}},autoComplete:{table:{disable:!0}},disabled:{table:{disable:!0}},form:{table:{disable:!0}},name:{table:{disable:!0}},required:{table:{disable:!0}},ariaDescribedBy:{table:{disable:!0}},onBlur:{table:{disable:!0}},onChange:{table:{disable:!0}},onFocus:{table:{disable:!0}},onHelpToggle:{table:{disable:!0}}},tags:["test"],parameters:{imageSnapshot:{disableSnapshot:!1}}},d="option1",c="option2",M="Ledetekst er obligatorisk",O="Ledetekst",U=[o.jsx(l.Option,{value:d,children:"Test 1"},"option_1"),o.jsx(l.Option,{value:c,children:"Test 2"},"option_2")],r={label:O,children:U},p={name:"With Ref (FA1)",args:{...r,ref:e=>{e&&(e.name="dummyNameForwardedFromRef")}},argTypes:{ref:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:e})=>{const a=i(e).getByRole("combobox");await t(a).toBeInTheDocument(),await t(a).toHaveAttribute("name","dummyNameForwardedFromRef")}},m={name:"With Attributes (FA2-5)",args:{...r,id:"htmlid",className:"dummyClassname",lang:"nb","data-testid":"123ID",form:"form123"},argTypes:{id:{table:{disable:!1}},className:{table:{disable:!1}},lang:{table:{disable:!1}},"data-testid":{table:{disable:!1}},form:{table:{disable:!1}}},parameters:{a11y:{test:"off"}},play:async({canvasElement:e})=>{const n=i(e),a=n.getByRole("combobox"),s=n.getAllByRole("generic")[1];await t(a).toHaveAttribute("id","htmlid"),await t(a).toHaveAttribute("data-testid","123ID"),await t(s).toHaveClass("dummyClassname"),await t(s).toHaveAttribute("lang","nb"),await t(a).toHaveAttribute("form","form123")}},u={name:"With Custom ClassNames (FA3)",args:{...r,classNames:{container:"dummyClassname",label:"dummyClassname",selectContainer:"dummyClassnameFormContainer",errorMessage:"dummyClassname"},errorMessage:M},argTypes:{classNames:{table:{disable:!1}}},play:async({canvasElement:e})=>{const n=i(e),a=e.querySelector(`${I} > div`),s=n.getByText(O),L=e.querySelector(`${I} > div > div`),F=e.querySelector("[id^=selectErrorId]>div");await t(a).toHaveClass("dummyClassname"),await t(s).toHaveClass("dummyClassname"),await t(L).toHaveClass("dummyClassnameFormContainer"),await t(F).toHaveClass("dummyClassname")}},b={name:"Defaults Variant Medium (A1, A2 delvis, A3, FS-A2, B2)",args:{...r},argTypes:{label:{table:{disable:!1}},children:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus-visible"]}},play:async({canvasElement:e})=>{const a=i(e).getByRole("combobox",{name:O});await t(a).toBeInTheDocument(),await t(a).toBeEnabled(),await t(a).toHaveValue(""),await t(a).toHaveTextContent(G()),await t(a).toHaveAttribute("id"),await t(a.tagName).toBe("SELECT"),await t(a).not.toBeRequired(),await t(a).not.toHaveAttribute("aria-invalid"),await t(a).not.toHaveAttribute("aria-describedby");const s=e.querySelector("[id^=selectErrorId]");await t(s).toBeInTheDocument()}},g={name:"With AriaDescribedBy",render:e=>{const n="select-alert-description-id";return o.jsxs(o.Fragment,{children:[o.jsx(l,{...e,ariaDescribedBy:n,hasSpacing:!0}),o.jsx(z,{id:n,variant:"warning",showAlert:!0,children:"Dette er en varselmelding for select"})]})},args:{...r},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:e})=>{const n=i(e),a=n.getByRole("combobox");await t(a).toHaveAttribute("aria-describedby");const s=n.getByText("Dette er en varselmelding for select");await t(s).toBeInTheDocument();const F=(a.getAttribute("aria-describedby")||"").split(" ").filter(Boolean);await t(F).toContain("select-alert-description-id")}},v={name:"With Variant Large (A1)",args:{...r,variant:"large"},argTypes:{variant:{table:{disable:!1}}}},h={name:"With Variant Large And Long Text",args:{...r,hidePlaceholder:!0,variant:"large",children:[o.jsx(l.Option,{value:d,children:"En lang tekst som ikke skal synes bak åpne ikonet"},"option_1")]},argTypes:{variant:{table:{disable:!1}},children:{table:{disable:!1}}},globals:{viewport:{value:"--mobile"}}},y={name:"With Disabled (B1, B6)",args:{...r,disabled:!0,value:d,helpText:"Hjelpeknappen skal også være disabled"},argTypes:{disabled:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus-visible"]}},play:async({canvasElement:e})=>{const n=i(e),a=n.getByRole("combobox");await t(a).toBeDisabled();const s=n.getByRole("button");await t(s).toBeDisabled()}},f={name:"With Value",args:{...r,value:c},argTypes:{value:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:e})=>{const a=i(e).getByRole("combobox");await t(a).toHaveValue(c)}},x={name:"With DefaultValue",args:{...r,defaultValue:c},argTypes:{defaultValue:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:e})=>{const a=i(e).getByRole("combobox");await t(a).toHaveValue(c)}},_="Velg fra listen noe gøy",S={name:"With AutoComplete Name And Placeholder (A2 delvis, B1)",args:{...r,autoComplete:"given-name",name:"test_name",placeholder:_},argTypes:{autoComplete:{table:{disable:!1}},name:{table:{disable:!1}},placeholder:{table:{disable:!1}}},play:async({canvasElement:e})=>{const n=i(e),a=n.getByRole("combobox");await t(a).toHaveAttribute("autocomplete","given-name"),await t(a).toHaveAttribute("name","test_name");const s=n.getByText(_);await t(s).toBeInTheDocument(),await t(s.tagName).toBe("OPTION")}},w={name:"With HidePlaceholder (A2 delvis)",args:{...r,hidePlaceholder:!0},argTypes:{hidePlaceholder:{table:{disable:!1}}},play:async({canvasElement:e})=>{const a=i(e).getByRole("combobox");await t(a).not.toHaveValue("")}},B={name:"With Required (B1, B4)",args:{...r,required:!0},argTypes:{required:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:e})=>{const a=i(e).getByRole("combobox");await t(a).toBeRequired(),await t(a).toHaveAttribute("aria-invalid","false")}},T={name:"With Required And Mark (B1, FS-A4 delvis)",args:{...r,required:!0,showRequiredMark:!0},argTypes:{required:{table:{disable:!1}},showRequiredMark:{table:{disable:!1}}}},A={name:"With ErrorMessage (A4 delvis, B5 delvis)",args:{...r,errorMessage:M},argTypes:{errorMessage:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus-visible"]}},play:async({canvasElement:e})=>{const n=i(e),a=n.getByRole("combobox",{description:M}),s=n.getAllByRole("generic")[3];await t(s).toBeInTheDocument(),await t(a).toHaveAttribute("aria-invalid","true"),await t(a).toHaveAttribute("aria-describedby")}},H={name:"With Description (FS-A3)",args:{...r,description:"En liten beskrivelse tekst"},argTypes:{description:{table:{disable:!1}}},play:async({canvasElement:e})=>{const n=i(e),a=n.getByText("En liten beskrivelse tekst");await t(a).toBeInTheDocument();const s=n.getByRole("combobox");await t(s).toHaveAttribute("aria-describedby");const L=s.getAttribute("aria-describedby");await t(L).toMatch(/descId-/)}},C={name:"With HideLabel (FS-A7)",args:{...r,hideLabel:!0},argTypes:{hideLabel:{table:{disable:!1}}},play:async({canvasElement:e})=>{const a=i(e).getByRole("combobox",{name:O});await t(a).toBeInTheDocument()}},W={name:"With HelpText (A1)",args:{...r,helpText:"Hjelpetekst"},argTypes:{helpText:{table:{disable:!1}}},play:async({canvasElement:e})=>{const a=i(e).getByRole("button",{description:O});await t(a).toBeInTheDocument(),await J.click(a)}},X=e=>{const[n,a]=$.useState("Tester events");return o.jsx(l,{...e,label:n,onFocus:s=>{a("Select har fått fokus"),e.onFocus&&e.onFocus(s)},onBlur:s=>{a("Select har blitt blurret"),e.onBlur&&e.onBlur(s)},onChange:s=>{a("Select har blitt klikket på"),e.onChange&&e.onChange(s)}})},N={render:X,name:"With EventHandlers (A3)",args:{...r,onFocus:V(),onBlur:V(),onChange:V()},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({args:e,canvasElement:n})=>{const s=i(n).getByRole("combobox");s.focus(),await P(()=>t(e.onFocus).toHaveBeenCalled()),await j.selectOptions(s,c),await P(()=>t(e.onChange).toHaveBeenCalled()),await j.tab(),await P(()=>t(e.onBlur).toHaveBeenCalled())}},E={name:"With onHelpToggle Event",args:{...r,helpText:"Hjelpetekst",onHelpToggle:e=>{alert(e?"Hjelpetekst blir vist":"Hjelpetekst skjules")}},parameters:{imageSnapshot:{disableSnapshot:!0}}},k={args:{label:"Ledetekst",className:"textField150",defaultValue:d,children:[o.jsx(l.Option,{value:d,children:"Long input tekst"},"option_1"),o.jsx(l.Option,{value:c,children:"Very very very long inputtext"},"option_2")]},argTypes:{variant:{table:{disable:!1}},defaultValue:{table:{disable:!1}}}},R={args:{label:"Ledetekst",className:"textField150",placeholder:"Long placeholder text",children:[o.jsx(l.Option,{value:d,children:"Long input tekst"},"option_1"),o.jsx(l.Option,{value:c,children:"Very very very long inputtext"},"option_2")]},argTypes:{variant:{table:{disable:!1}},placeholder:{table:{disable:!1}}}},Y=()=>o.jsxs("div",{className:"flex gapS",children:[o.jsxs(l,{label:"Fruktsort",required:!0,children:[o.jsx(l.Option,{value:1,children:"Banan"}),o.jsx(l.Option,{value:2,children:"Eple"})]}),o.jsxs(l,{label:"Fruktsort",helpText:"Velg frukten du liker best.",required:!0,children:[o.jsx(l.Option,{value:1,children:"Banan"}),o.jsx(l.Option,{value:2,children:"Eple"})]})]}),D={render:Y};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  name: 'With Ref (FA1)',
  args: {
    ...defaultArgs,
...
} satisfies Story`,...W.parameters?.docs?.source}}};N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
...
} satisfies Story`,...N.parameters?.docs?.source}}};E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  ...
  render: TwoSelects
}`,...D.parameters?.docs?.source}}};const Q=["WithRef","WithAttributes","WithCustomClassNames","Defaults","WithAriaDescribedBy","WithVariantLarge","WithVariantLargeAndLongText","WithDisabled","WithValue","WithDefaultValue","WithAutoCompleteNameAndPlaceholder","WithHidePlaceholder","WithRequired","WithRequiredAndMark","WithErrorMessage","WithDescription","WithHideLabel","WithHelpText","WithEventHandlers","WithHelpToggleEvent","WithLongInput","WithLongPlaceholder","TwoSelectsOneWithHelpText"],re=Object.freeze(Object.defineProperty({__proto__:null,Defaults:b,TwoSelectsOneWithHelpText:D,WithAriaDescribedBy:g,WithAttributes:m,WithAutoCompleteNameAndPlaceholder:S,WithCustomClassNames:u,WithDefaultValue:x,WithDescription:H,WithDisabled:y,WithErrorMessage:A,WithEventHandlers:N,WithHelpText:W,WithHelpToggleEvent:E,WithHideLabel:C,WithHidePlaceholder:w,WithLongInput:k,WithLongPlaceholder:R,WithRef:p,WithRequired:B,WithRequiredAndMark:T,WithValue:f,WithVariantLarge:v,WithVariantLargeAndLongText:h,__namedExportsOrder:Q,default:K},Symbol.toStringTag,{value:"Module"}));export{re as S};
//# sourceMappingURL=Select.test.stories-BAkuyiHV.js.map
