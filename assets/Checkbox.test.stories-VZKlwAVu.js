import{r as _,j as O}from"./iframe-BQX7p2fO.js";import{C as I}from"./index-Dz9Mp0Gs.js";const{expect:n,fn:M,userEvent:P,waitFor:j,within:i}=__STORYBOOK_MODULE_TEST__,L=(a,t)=>async({canvasElement:e})=>{const q=i(e).getByRole("checkbox");await n(q).toBeInTheDocument(),await n(q).toHaveAttribute(a,t)},V={component:I,title:"Tester/Checkbox",argTypes:{ref:{table:{disable:!0}},className:{table:{disable:!0}},id:{table:{disable:!0}},lang:{table:{disable:!0}},"data-testid":{table:{disable:!0}},classNames:{table:{disable:!0}},children:{table:{disable:!0}},defaultChecked:{table:{disable:!0}},description:{table:{disable:!0}},errorMessage:{table:{disable:!0}},hasSpacing:{table:{disable:!0}},hideLabel:{table:{disable:!0}},showRequiredMark:{table:{disable:!0}},checked:{table:{disable:!0}},disabled:{table:{disable:!0}},form:{table:{disable:!0}},name:{table:{disable:!0}},required:{table:{disable:!0}},value:{table:{disable:!0}},ariaDescribedby:{table:{disable:!0}},onBlur:{table:{disable:!0}},onChange:{table:{disable:!0}},onFocus:{table:{disable:!0}}},tags:["test"],parameters:{imageSnapshot:{disableSnapshot:!1}}},H="Checkbox",F="Du må lese og forstå innholdet for å gå videre",s={children:H},o={name:"With Ref (FA1)",args:{...s,ref:a=>{a&&(a.name="dummyNameForwardedFromRef")}},argTypes:{ref:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:L("name","dummyNameForwardedFromRef")},c={name:"With Attributes (FA2-5)",args:{...s,id:"htmlid",className:"dummyClassname",lang:"nb","data-testid":"123ID",form:"123form"},argTypes:{id:{table:{disable:!1}},className:{table:{disable:!1}},lang:{table:{disable:!1}},"data-testid":{table:{disable:!1}},form:{table:{disable:!1}}},parameters:{a11y:{test:"off"}},play:async({canvasElement:a})=>{const t=i(a),e=t.getByRole("checkbox"),r=t.getAllByRole("generic")[1];await n(e).toHaveAttribute("id","htmlid"),await n(r).toHaveClass("dummyClassname"),await n(r).toHaveAttribute("lang","nb"),await n(e).toHaveAttribute("data-testid","123ID"),await n(e).toHaveAttribute("form","123form")}},l={name:"Defaults (A1, B1)",args:{...s},argTypes:{children:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus","active"]}},play:async({canvasElement:a})=>{const e=i(a).getByLabelText(H);await n(e).toBeInTheDocument(),await n(e.tagName).toBe("INPUT"),await n(e).not.toHaveAttribute("aria-invalid"),await n(e).not.toBeChecked(),await n(e).not.toBeRequired(),await n(e).toBeEnabled(),await n(e).not.toHaveAttribute("aria-describedby");const r=a.querySelector("[id^=checkboxErrorId]");await n(r).toBeInTheDocument()}},d={name:"With Description (A1)",args:{...s,description:"En beskrivelse av punktet"},argTypes:{description:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus","active"]}},play:async({canvasElement:a})=>{const t=i(a),e=t.getByText("En beskrivelse av punktet");await n(e).toBeInTheDocument();const r=t.getByRole("checkbox");await n(r).toHaveAttribute("aria-describedby");const q=r.getAttribute("aria-describedby");await n(q).toMatch(/descId-/)}},u={name:"With Description And Long Text (A1)",args:{...s,children:"Får ekstra lang reisevei til jobb på grunn av levering til barnehage eller skolefritidsordning eller annen fritidsordning",description:"Litt rart å ha en beskrivende tekst rett under en lang tekst, men sånn har det blitt"},argTypes:{description:{table:{disable:!1}}},globals:{viewport:{value:"--breakpoint-xs"}}},b={name:"With Description And Disabled (A1)",args:{...s,description:"En beskrivelse av punktet",disabled:!0},argTypes:{description:{table:{disable:!1}},disabled:{table:{disable:!1}}}},p={name:"With Long Text (A2)",args:{...s,children:"Får ekstra lang reisevei til jobb på grunn av levering til barnehage eller skolefritidsordning eller annen fritidsordning"},argTypes:{children:{table:{disable:!1}}},globals:{viewport:{value:"--breakpoint-xs"}}},m={name:"With Long Text And Breaking (A2)",args:{...s,children:"Fårekstrareiseveitiljobbpågrunnavleveringtilbarnehageellerskolefritidsordning"},argTypes:{children:{table:{disable:!1}}},globals:{viewport:{value:"--breakpoint-xs"}}},h={name:"With HideLabel (A2)",args:{...s,hideLabel:!0},argTypes:{hideLabel:{table:{disable:!1}}},play:async({canvasElement:a})=>{const e=i(a).getByLabelText(H);await n(e).toBeInTheDocument()}},g={name:"With Checked (A1, A3)",args:{...s,checked:!0},argTypes:{checked:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus","active"]}},play:async({canvasElement:a})=>{const e=i(a).getByRole("checkbox");await n(e).toBeChecked(),await n(e).not.toHaveAttribute("aria-invalid")}},v={name:"With Disabled (A1, A5 delvis, B2)",args:{...s,disabled:!0},argTypes:{disabled:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus","active"]}},play:async({canvasElement:a})=>{const e=i(a).getByRole("checkbox");await n(e).toBeDisabled()}},y={name:"With Disabled And Checked (A1, A5 delvis, B2)",args:{...s,checked:!0,disabled:!0},argTypes:{checked:{table:{disable:!1}},disabled:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus","active"]}},play:async({canvasElement:a})=>{const e=i(a).getByRole("checkbox");await n(e).toBeChecked(),await n(e).toBeDisabled()}},f={name:"With Required (B3)",args:{...s,required:!0},argTypes:{required:{table:{disable:!1}}},play:async({canvasElement:a})=>{const e=i(a).getByRole("checkbox");await n(e).toBeRequired(),await n(e).toHaveAttribute("aria-invalid","false")}},k={name:"With Required And Mark (A1, B3)",args:{...s,required:!0,showRequiredMark:!0},argTypes:{required:{table:{disable:!1}},showRequiredMark:{table:{disable:!1}}}},A={name:"With Required And Checked (B3)",args:{...s,checked:!0,required:!0},argTypes:{checked:{table:{disable:!1}},required:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:a})=>{const e=i(a).getByRole("checkbox");await n(e).toBeChecked(),await n(e).toBeRequired(),await n(e).toHaveAttribute("aria-invalid","false")}},x={name:"With ErrorMessage (A1, B4)",args:{...s,errorMessage:F},argTypes:{errorMessage:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus","active"]}},play:async({canvasElement:a})=>{const t=i(a),e=a.querySelector("[id^=checkboxErrorId]>div");await n(e).toBeInTheDocument();const r=t.getByRole("checkbox",{description:F});await n(r).toHaveAttribute("aria-invalid","true")}},w={name:"With Disabled And Required (A1)",args:{...s,disabled:!0,required:!0,showRequiredMark:!0},argTypes:{disabled:{table:{disable:!1}},required:{table:{disable:!1}},showRequiredMark:{table:{disable:!1}}},play:async({canvasElement:a})=>{const e=i(a).getByRole("checkbox");await n(e).toBeDisabled(),await n(e).toBeRequired(),await n(e).toHaveAttribute("aria-invalid","false")}},S={name:"With Error And Required (A1)",args:{...s,errorMessage:"Feilmelding",required:!0,showRequiredMark:!0},argTypes:{errorMessage:{table:{disable:!1}},required:{table:{disable:!1}},showRequiredMark:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus","active"]}},play:async({canvasElement:a})=>{const e=i(a).getByRole("checkbox");await n(e).toHaveAttribute("aria-invalid","true"),await n(e).toBeRequired()}},B={name:"With AriaDescribedby (B1)",args:{...s,ariaDescribedby:"testID"},argTypes:{ariaDescribedby:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:a})=>{const e=i(a).getByRole("checkbox");await n(e).toHaveAttribute("aria-describedby"),await n(e).toHaveAttribute("aria-describedby",n.stringMatching("testID"))}},W={name:"With Value",args:{...s,value:"test_value_checkbox"},argTypes:{value:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:L("value","test_value_checkbox")},T={name:"With DefaultChecked",args:{...s,defaultChecked:!0},argTypes:{defaultChecked:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:a})=>{const e=i(a).getByRole("checkbox");await n(e).toBeChecked()}},R={name:"With Name",args:{...s,name:"test_name_checkbox"},argTypes:{name:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:L("name","test_name_checkbox")},U=a=>{const[t,e]=_.useState("Checkbox");return O.jsx(I,{...a,onBlur:r=>{e("Checkbox har mistet fokus"),a.onBlur&&a.onBlur(r)},onChange:r=>{e("Checkbox har blitt klikket på"),a.onChange&&a.onChange(r)},onFocus:r=>{e("Checkbox har fått fokus"),a.onFocus&&a.onFocus(r)},children:t})},N={render:U,name:"With EventHandlers",args:{...s,onBlur:M(),onChange:M(),onFocus:M()},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({args:a,canvasElement:t})=>{const r=i(t).getByRole("checkbox");await P.click(r),await j(()=>n(a.onChange).toHaveBeenCalled()),r.focus(),await n(r).toHaveFocus(),r.blur(),await n(r).not.toHaveFocus()}},C={name:"With Custom ClassNames (FA3)",args:{...s,classNames:{label:"dummyClassname",errorMessage:"dummyClassname"},errorMessage:F},argTypes:{classNames:{table:{disable:!1}}},play:async({canvasElement:a})=>{const e=i(a).getByText(H),r=a.querySelector("[id^=checkboxErrorId]>div");await n(e?.parentElement).toHaveClass("dummyClassname"),await n(r).toHaveClass("dummyClassname")}},E={name:"With ReadOnly",args:{...s,readOnly:!0,description:"Dette er en checkbox i read only modus"},argTypes:{readOnly:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus","active"]}},play:async({canvasElement:a})=>{const e=i(a).getByRole("checkbox");await n(e).toHaveAttribute("data-read-only","true"),n(e).toHaveAccessibleName(/,\s*skrivebeskyttet/)}},D={name:"With ReadOnly And Checked",args:{...s,readOnly:!0,checked:!0,description:"Dette er en checkbox i read only modus"},argTypes:{readOnly:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus","active"]}},play:async({canvasElement:a})=>{const e=i(a).getByRole("checkbox");await n(e).toHaveAttribute("data-read-only","true"),n(e).toHaveAccessibleName(/,\s*skrivebeskyttet/)}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  name: 'With Ref (FA1)',
  args: {
    ...defaultArgs,
  ...
  play: async ({
    ...
    const errorMessageContainer = canvasElement.querySelector('[id^=checkboxErrorId]');
  ...
  play: async ({
    ...
    const canvas = within(canvasElement);
    const errorMessage = canvasElement.querySelector('[id^=checkboxErrorId]>div');
...
} satisfies Story`,...D.parameters?.docs?.source}}};const z=["WithRef","WithAttributes","Defaults","WithDescription","WithDescriptionAndLongText","WithDescriptionAndDisabled","WithLongText","WithLongTextAndBreaking","WithHideLabel","WithChecked","WithDisabled","WithDisabledAndChecked","WithRequired","WithRequiredAndMark","WithRequiredAndChecked","WithError","WithDisabledAndRequired","WithErrorAndRequired","WithAriaDescribedby","WithValue","WithDefaultChecked","WithName","WithEventHandlers","WithCustomClassNames","WithReadOnly","WithReadOnlyAndChecked"],G=Object.freeze(Object.defineProperty({__proto__:null,Defaults:l,WithAriaDescribedby:B,WithAttributes:c,WithChecked:g,WithCustomClassNames:C,WithDefaultChecked:T,WithDescription:d,WithDescriptionAndDisabled:b,WithDescriptionAndLongText:u,WithDisabled:v,WithDisabledAndChecked:y,WithDisabledAndRequired:w,WithError:x,WithErrorAndRequired:S,WithEventHandlers:N,WithHideLabel:h,WithLongText:p,WithLongTextAndBreaking:m,WithName:R,WithReadOnly:E,WithReadOnlyAndChecked:D,WithRef:o,WithRequired:f,WithRequiredAndChecked:A,WithRequiredAndMark:k,WithValue:W,__namedExportsOrder:z,default:V},Symbol.toStringTag,{value:"Module"}));export{G as C};
//# sourceMappingURL=Checkbox.test.stories-VZKlwAVu.js.map
