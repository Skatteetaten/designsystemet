import{z as B}from"./index-CR6dT-y4.js";import{a as w}from"./storybook.testing.utils-BgHZnMzD.js";import{L as H}from"./LabelWithHelp-B6OnnC-V.js";import{S}from"./icon.systems-WAvM-z7u.js";const{expect:n,fireEvent:A,userEvent:W,within:i}=__STORYBOOK_MODULE_TEST__,C={component:H,title:"Tester/LabelWithHelp (intern)",argTypes:{ref:{table:{disable:!0}},className:{table:{disable:!0}},id:{table:{disable:!0}},lang:{table:{disable:!0}},"data-testid":{table:{disable:!0}},classNames:{table:{disable:!0}},children:{table:{disable:!0}},description:{table:{disable:!0}},disabled:{table:{disable:!0}},helpText:{table:{disable:!0}},helpSvgPath:{table:{disable:!0},options:Object.keys(S),mapping:S},hideLabel:{table:{disable:!0}},showRequiredMark:{table:{disable:!0}},titleHelpSvg:{table:{disable:!0}},htmlFor:{table:{disable:!0}},onHelpToggle:{table:{disable:!0}}},tags:["test"],parameters:{imageSnapshot:{disableSnapshot:!1}}},T="Kort hjelpetekst",x="Vi trenger å vite navnet ditt dersom vi skal kontakte deg senere.",l="Ledetekst",s={children:l},o={name:"With Ref (FA1)",args:{...s,ref:e=>{e&&(e.id="dummyIdForwardedFromRef")}},argTypes:{ref:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:e})=>{const a=i(e).getByText(l);await n(a).toHaveAttribute("id","dummyIdForwardedFromRef")}},c={name:"With Attributes (FA2-5)",args:{...s,id:"htmlid",className:"dummyClassname",lang:"nb","data-testid":"123ID"},argTypes:{id:{table:{disable:!1}},className:{table:{disable:!1}},lang:{table:{disable:!1}},"data-testid":{table:{disable:!1}}},parameters:{a11y:{test:"off"}},play:async({canvasElement:e})=>{const a=i(e).getByText(l);await n(a).toHaveAttribute("id","htmlid"),await n(a).toHaveClass("dummyClassname"),await n(a).toHaveAttribute("lang","nb"),await n(a).toHaveAttribute("data-testid","123ID")}},d={name:"Default (FS-A1, FS-A2, FS-A4, FS-B1)",args:{...s},argTypes:{children:{table:{disable:!1}}},play:async({canvasElement:e})=>{const a=i(e).getByText(l);await n(a.tagName).toBe("LABEL")}},p={name:"With Description (FS-A3)",args:{...s,description:T},argTypes:{description:{table:{disable:!1}}},play:async({canvasElement:e})=>{const a=i(e).getByText(T);await n(a).toBeInTheDocument()}},m={name:"With ShowRequiredMark (FS-A4)",args:{...s,showRequiredMark:!0},argTypes:{showRequiredMark:{table:{disable:!1}}}},b={name:"With HideLabel (FS-A7)",args:{...s,description:T,helpText:x,hideLabel:!0},argTypes:{hideLabel:{table:{disable:!1}}},play:async({canvasElement:e})=>{const t=i(e),a=t.getByText(l),r=t.getByText(T),f=t.getByRole("button");await n(a).toBeInTheDocument(),await n(r).toBeInTheDocument(),await n(f).toBeInTheDocument()}},u={name:"With HelpText HelpSvgPath And TitleHelpSvg (FS-A1, FS-A5 delvis, FS-B2 delvis)",args:{...s,helpText:x,helpSvgPath:B,titleHelpSvg:"Tooltip"},argTypes:{helpText:{table:{disable:!1}},helpSvgPath:{table:{disable:!1}},titleHelpSvg:{table:{disable:!1}}},play:async({canvasElement:e})=>{const t=i(e),a=t.getByRole("button",{description:l});await n(a).toBeInTheDocument();const r=t.getByLabelText("Tooltip",{selector:"svg"});await n(r).toBeInTheDocument();const f=t.getByText(l);await n(a).toHaveAttribute("aria-describedby",f.id),await W.click(a)}},h={name:"With Long Children",args:{...s,children:w},argTypes:{children:{table:{disable:!1}}},globals:{viewport:{value:"--mobile"}}},g={name:"With onHelpToggle Event",args:{...s,helpText:"Hjelpetekst",onHelpToggle:e=>{alert(e?"Hjelpetekst blir vist":"Hjelpetekst skjules")}},parameters:{imageSnapshot:{disableSnapshot:!0}}},v={name:"With Custom ClassNames (FA3)",args:{...s,classNames:{label:"dummyClassname",description:"dummyClassname",helpText:"dummyClassname"},description:"beskrivelse",helpText:"hjelp"},argTypes:{classNames:{table:{disable:!1}}},play:async({canvasElement:e})=>{const t=i(e),a=t.getByText(l);await n(a).toHaveClass("dummyClassname"),await n(t.getByText("beskrivelse")).toHaveClass("dummyClassname"),await A.click(t.getByRole("button"));const r=t.getByText("hjelp").parentElement;await n(r).toHaveClass("dummyClassname")}},y={name:"With Disabled",args:{...s,helpText:"Hjelpetekst",disabled:!0},argTypes:{disabled:{table:{disable:!1}}},play:async({canvasElement:e})=>{const a=i(e).getByRole("button");await n(a).toBeDisabled()}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  name: 'With Ref (FA1)',
  args: {
    ...defaultArgs,
...
} satisfies Story`,...y.parameters?.docs?.source}}};const D=["WithRef","WithAttributes","Defaults","WithDescription","WithShowRequiredMark","WithHideLabel","WithHelpTextSvgPathAndTitle","WithLongChildren","WithHelpToggleEvent","WithCustomClassNames","WithDisabled"],N=Object.freeze(Object.defineProperty({__proto__:null,Defaults:d,WithAttributes:c,WithCustomClassNames:v,WithDescription:p,WithDisabled:y,WithHelpTextSvgPathAndTitle:u,WithHelpToggleEvent:g,WithHideLabel:b,WithLongChildren:h,WithRef:o,WithShowRequiredMark:m,__namedExportsOrder:D,default:C},Symbol.toStringTag,{value:"Module"}));export{N as L};
//# sourceMappingURL=LabelWithHelp.test.stories-CEQte7W5.js.map
