import{F as w,r as l,l as k,j as e,J as F}from"./iframe-s2_bNgHU.js";import{b as O,I as m,B as p}from"./index-Ck1G954W.js";import{D as s,C as g,P as b}from"./index-jj9Gfu02.js";import"./index-D9_nlc1h.js";import{a9 as H,U as V,E as T,D as q,a5 as G,ac as z}from"./index-CUsfAC9p.js";import{M as $}from"./index-C_DRppF7.js";import{H as h,P as K}from"./index-CJpzHRrE.js";import{w as J}from"./pagelayout-decorator-Cpq_UyUi.js";import{T as v}from"./DatePickerCalendar-ePUd64Qm.js";import"./preload-helper-PPVm8Dsz.js";import"./index-DcFKixUR.js";import"./Help-DC9TS-B6.js";import"./Combobox.module-CSHfGvVK.js";import"./ComboboxButton-COhLZqHg.js";import"./ComboboxSelectedOptions-DI0eIcsf.js";import"./index-DFs0_No2.js";import"./LabelWithHelp-rfkuXU1a.js";import"./index-DdQvxWAg.js";import"./floating-ui.react-E96A4XpZ.js";import"./index-Dl0hHgc-.js";import"./index-CYEZhpn0.js";import"./index-BjBiKebW.js";import"./index-7wWg-Emv.js";import"./TopBannerButton-DfVK1v-G.js";import"./TopBannerLangPicker-B12Cqjgb.js";import"./TopBannerLangPickerButton-B89Cuo20.js";import"./TopBannerLogo-2_yXoyy5.js";import"./TopBannerSkipLink-pDXC9-Fu.js";import"./TopBannerUserButton-CgWAyyOh.js";import"./TopBannerExternalExample.module-D-cyqUXs.js";const Q="_mainExternal_1e5vg_1",U="_tabIndexNoOutline_1e5vg_13",X="_miniNav_1e5vg_17",W="_article_1e5vg_24",Y="_desciptionList_1e5vg_33",Z="_repeatingFields_1e5vg_39",ee="_addNewButton_1e5vg_47",ne="_editModal_1e5vg_51",te="_editModalContent_1e5vg_55",se="_flexStartRow_1e5vg_61",ae="_editModalAdressFields_1e5vg_67",re="_cardContent_1e5vg_76",ie="_panel_1e5vg_80",de="_panelContent_1e5vg_84",t={mainExternal:Q,tabIndexNoOutline:U,miniNav:X,article:W,desciptionList:Y,repeatingFields:Z,addNewButton:ee,editModal:ne,editModalContent:te,flexStartRow:se,editModalAdressFields:ae,cardContent:re,panel:ie,panelContent:de},le=`.mainExternal {
...
`,He={title:"Sidetyper/Ekstern/Repeterende felter",decorators:[J],parameters:{layout:"fullscreen",controls:{disable:!0},docs:{source:{transform:w(le)}}}};function x(){const u=l.useRef(null),L=l.useRef(null),S=l.useRef(null),[i,f]=l.useState(null),[o,R]=l.useState(3),N=!k("(min-width: 480px)"),E={name:"Hopp Og Sprett Barnehage",organizationNumber:"123456789"},A=[{id:1,navn:"McRonald Hansen",adresse:"Adresseveien 1",postnummer:"1314",poststed:"Kolbotn",rolle:"Styreleder"},{id:2,navn:"Hans McRonald",adresse:"Adresseveien 2",postnummer:"1314",poststed:"Kolbotn",rolle:"Styremedlem"}],[c,C]=l.useState(()=>A),y=n=>{requestAnimationFrame(()=>{document.querySelector(`[data-card-id="${n}"]`)?.focus()})},[,M,I]=l.useActionState(async(n,r)=>{if(!i)return{success:!1,error:"Ingen kort å redigere"};const d={id:i.id,navn:r.get("navn"),adresse:r.get("adresse"),postnummer:r.get("postnummer"),poststed:i.poststed,rolle:r.get("rolle")};return await new Promise(a=>setTimeout(a,1e3)),C(a=>a.map(j=>j.id===d.id?d:j)),u.current?.close(),f(null),{success:!0}},{success:!1}),_=n=>{f({...n}),u.current?.showModal()},D=()=>{const n={id:o,navn:`Ny person ${o}`,adresse:`Adresseveien ${o}`,postnummer:"0000",poststed:"Sted",rolle:"Rolle"};C(r=>[...r,n]),y(o),R(o+1)},B=()=>{u.current?.close(),f(null)},P=n=>{const r=c.findIndex(a=>a.id===n),d=c.filter(a=>a.id!==n);C(d),requestAnimationFrame(()=>{if(d.length===0)S.current?.focus();else{let a;r>0?a=d[r-1].id:a=d[0].id,y(a)}})};return e.jsxs("main",{className:t.mainExternal,tabIndex:-1,children:[e.jsxs("div",{className:t.miniNav,children:[e.jsx(O,{href:"#",svgPath:H,children:"Til Min side"}),e.jsx(m,{svgPath:V,children:"Skriv ut"})]}),e.jsxs("div",{className:t.article,children:[e.jsx(h,{as:"h1",level:1,hasSpacing:!0,children:"Skjema eller oppgave"}),e.jsxs(s,{className:t.desciptionList,hasSpacing:!0,children:[e.jsx(s.Element,{term:"Virksomhetens navn",children:E.name}),e.jsx(s.Element,{term:N?"Organisasjons-nummer":"Organisasjonsnummer",children:F(E.organizationNumber)}),e.jsx(s.Element,{term:"Inntektsår",children:"2023"})]})]}),e.jsxs("div",{className:t.article,children:[e.jsx("div",{ref:S,className:t.tabIndexNoOutline,tabIndex:-1,children:e.jsx(h,{as:"h2",level:2,hasSpacing:!0,children:"Overskift/kategori"})}),e.jsx("ul",{className:t.repeatingFields,children:c.length===0?e.jsx("li",{children:e.jsx(K,{children:"Ingen personer i listen."})}):c.map(n=>e.jsx("li",{children:e.jsxs(g,{spacing:"m",color:"graphite",children:[e.jsx(g.Header,{children:e.jsx("div",{"data-card-id":n.id,className:t.tabIndexNoOutline,tabIndex:-1,children:e.jsx(h,{as:"h3",level:3,hasSpacing:!0,children:n.navn})})}),e.jsx(g.Content,{className:t.cardContent,children:e.jsxs(s,{descriptionDirection:N?"vertical":"horizontal",className:t.desciptionList,children:[e.jsx(s.Element,{term:"Adresse",children:n.adresse}),e.jsx(s.Element,{term:"Postnummer",children:n.postnummer}),e.jsx(s.Element,{term:"Poststed",children:n.poststed}),e.jsx(s.Element,{term:"Rolle",children:n.rolle})]})}),e.jsxs(g.Actions,{children:[e.jsx(m,{svgPath:T,onClick:()=>_(n),children:"Rediger"}),e.jsx(m,{svgPath:q,onClick:()=>P(n.id),children:"Slett"})]})]},n.id)},n.id))}),e.jsx(p,{svgPath:G,className:t.addNewButton,onClick:D,children:"Legg til ny person"}),e.jsx($,{ref:u,title:"Rediger person",className:t.editModal,children:i&&e.jsxs("form",{action:M,className:t.editModalContent,children:[e.jsxs("div",{children:[e.jsx(v,{ref:L,label:"Navn",name:"navn",defaultValue:i.navn,hasSpacing:!0,required:!0}),e.jsx(v,{label:"Adresse",name:"adresse",defaultValue:i.adresse,hasSpacing:!0,required:!0}),e.jsxs("div",{className:t.editModalAdressFields,children:[e.jsx(v,{label:"Postnummer",name:"postnummer",defaultValue:i.postnummer,hasSpacing:!0,required:!0}),e.jsx(s,{descriptionDirection:"vertical",children:e.jsx(s.Element,{term:"Poststed",children:i.poststed})})]}),e.jsx(v,{label:"Rolle",name:"rolle",defaultValue:i.rolle,hasSpacing:!0,required:!0})]}),e.jsxs("div",{className:t.flexStartRow,children:[e.jsx(p,{type:"submit",hasSpinner:I,children:I?"Lagrer...":"Lagre"}),e.jsx(p,{variant:"secondary",onClick:B,children:"Avbryt"})]})]})})]}),e.jsxs(b,{color:"forest",renderIcon:()=>e.jsx(z,{size:"extraLarge"}),className:t.panel,hideGraphicMobile:!0,children:[e.jsx(h,{as:"h3",level:3,hasSpacing:!0,children:"Foreløpig oppsummering"}),e.jsx(s,{children:e.jsx(s.Element,{term:"Antall personer",children:c.length})})]}),e.jsxs("div",{className:`${t.flexStartRow} ${t.article}`,children:[e.jsx(p,{children:"Send inn"}),e.jsx(p,{variant:"secondary",children:"Avbryt"})]}),e.jsx(b,{color:"graphite",variant:"filled",padding:"s",className:t.panel,children:e.jsxs("div",{className:t.panelContent,children:[e.jsx(m,{children:"Lagre og fortsett senere"}),e.jsx(m,{children:"Avbryt og slett"})]})})]})}x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`function RepeterendeFelter(): JSX.Element {
...
//# sourceMappingURL=RepeterendeFelter.stories-BxcPV8x4.js.map
