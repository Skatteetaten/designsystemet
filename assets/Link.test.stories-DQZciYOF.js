import{j as me,d as ge,r as be}from"./iframe-DRo7xN6O.js";import{b as S}from"./index-C6akGUuV.js";import{g as x,f as ve}from"./index-CIGiQTsv.js";import{S as w}from"./icon.systems-YNVHmwDx.js";import{l as he}from"./base-props.types-B340BQPQ.js";const{expect:t,fn:ye,userEvent:fe,waitFor:ke,within:l}=__STORYBOOK_MODULE_TEST__,A="htmlId",pe="0 0 24 24",ue="Er du pendler?",T=(e,s)=>async({canvasElement:a})=>{const n=l(a);await t(n.getByRole("link")).toHaveAttribute(e,s)},Ae={component:S,title:"Tester/Link",argTypes:{ref:{table:{disable:!0}},className:{table:{disable:!0}},id:{table:{disable:!0}},lang:{table:{disable:!0}},"data-testid":{table:{disable:!0}},children:{table:{disable:!0}},isExternal:{table:{disable:!0}},color:{table:{disable:!0},options:[void 0,...he],control:"inline-radio"},svgPath:{table:{disable:!0},options:Object.keys(w),mapping:w},title:{table:{disable:!0}},href:{table:{disable:!0}},target:{table:{disable:!0}},download:{table:{disable:!0}},ariaCurrent:{table:{disable:!0}},ariaDescribedby:{table:{disable:!0}},onBlur:{table:{disable:!0}},onClick:{table:{disable:!0}},onFocus:{table:{disable:!0}}},tags:["test"],parameters:{imageSnapshot:{disableSnapshot:!1}}},i=e=>me.jsx(S,{...e,onClick:s=>s.preventDefault(),children:e.children}),r={href:"#storybook-root",children:ue},o={render:i,name:"With Ref (FA1)",args:{...r,ref:e=>{e&&(e.id="dummyIdForwardedFromRef")}},argTypes:{ref:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:T("id","dummyIdForwardedFromRef")},c={render:i,name:"With Attributes(FA2-5)",args:{...r,id:A,className:"dummyClassname",lang:"nb","data-testid":"123ID"},argTypes:{id:{table:{disable:!1}},className:{table:{disable:!1}},lang:{table:{disable:!1}},"data-testid":{table:{disable:!1}}},parameters:{a11y:{test:"off"}},play:async({canvasElement:e})=>{const a=l(e).getByRole("link");await t(a).toHaveClass("dummyClassname"),await t(a).toHaveAttribute("id",A),await t(a).toHaveAttribute("lang","nb"),await t(a).toHaveAttribute("data-testid","123ID")}},d={render:i,name:"Defaults (A1 delvis, A2, A3 delvis, B1)",args:{...r},argTypes:{href:{table:{disable:!1}},children:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus","active"]}},play:async({canvasElement:e})=>{const a=l(e).getByRole("link");await t(a).not.toHaveAttribute("rel"),await t(a).not.toHaveAttribute("target");const n=a.querySelector("svg");await t(n).not.toBeInTheDocument(),t(a).toHaveTextContent(ue)}},m={render:i,name:"With Long Text (A1 delvis)",args:{...r,children:"Denne lenken har en veldig lang tekst. Så lang at den lange teksten tvinger fram linjeskift med tekst som alltid er venstrejustert uansett om ikon eller ikke."},argTypes:{children:{table:{disable:!1}}}},p={render:i,name:"With Long Text And Icons (A1 delvis)",args:{...r,isExternal:!0,svgPath:x,children:"Denne lenken har en veldig lang tekst med ikon på venstre side. Så lang at den lange teksten tvinger fram linjeskift hvor tekst er venstrejustert."},argTypes:{isExternal:{table:{disable:!1}},svgPath:{table:{disable:!1}},children:{table:{disable:!1}}}},u={render:i,name:"With Icon (A4, B2)",args:{...r,svgPath:x},argTypes:{svgPath:{table:{disable:!1}}},play:async({canvasElement:e})=>{const n=l(e).getByRole("link").querySelector("svg");await t(n).toHaveAttribute("aria-hidden","true"),await t(n).toHaveAttribute("viewBox",pe)}},g={render:i,name:"With External Icon (A5)",args:{...r,isExternal:!0},argTypes:{isExternal:{table:{disable:!1}}},play:async({canvasElement:e})=>{const n=l(e).getByRole("link").querySelector("svg");await t(n).toHaveAttribute("aria-label",ge.t("ds_buttons:shared.ExternalIcon")),await t(n).toHaveAttribute("viewBox",pe)}},b={render:i,name:"With Color (A6)",args:{...r,color:"white",isExternal:!0,svgPath:ve},argTypes:{color:{table:{disable:!1}}},parameters:{imageSnapshot:{pseudoStates:["hover","focus","active"]}},globals:{backgrounds:{value:"themePrimary"}}},v={render:i,name:"With Target (A2)",args:{...r,target:"_blank"},argTypes:{target:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:e})=>{const a=l(e).getByRole("link");t(a).toHaveAttribute("rel","noreferrer"),t(a).toHaveAttribute("target","_blank")}},h={render:i,name:"With Download",args:{...r,download:"testFil.txt"},argTypes:{download:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:e})=>{const a=l(e).getByRole("link");t(a).toHaveAttribute("download","testFil.txt")}},y={render:i,name:"With AriaDescribedby (B3)",args:{...r,ariaDescribedby:A},argTypes:{ariaDescribedby:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:T("aria-describedby",A)},f={name:"With AriaCurrent",args:{...r,ariaCurrent:!0},argTypes:{ariaCurrent:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:T("aria-current","true")},Se="Ny lenketekst slik at vi ser at event fungerte",xe=e=>{const[s,a]=be.useState("Klikk på lenken for å teste onClick event");return me.jsx(S,{...e,onClick:n=>{n.preventDefault(),a(Se),e.onClick&&e.onClick(n)},children:s})},k={render:xe,name:"With onClick (A3 delvis)",args:{...r,svgPath:x,onClick:ye()},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({args:e,canvasElement:s})=>{const n=l(s).getByRole("link");await t(n).toHaveTextContent("Klikk på lenken for å teste onClick event"),await fe.click(n),await t(n).toHaveTextContent("Ny lenketekst slik at vi ser at event fungerte"),await ke(()=>t(e.onClick).toHaveBeenCalled())}};var C,W,E;o.parameters={...o.parameters,docs:{...(C=o.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: Template,
  name: 'With Ref (FA1)',
  args: {
    ...defaultArgs,
...
} satisfies Story`,...(V=(O=p.parameters)==null?void 0:O.docs)==null?void 0:V.source}}};var N,G,q;u.parameters={...u.parameters,docs:{...(N=u.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: Template,
...
} satisfies Story`,...(z=(M=g.parameters)==null?void 0:M.docs)==null?void 0:z.source}}};var U,Y,J;b.parameters={...b.parameters,docs:{...(U=b.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: Template,
  name: 'With Color (A6)',
  args: {
    ...defaultArgs,
...
} satisfies Story`,...(J=(Y=b.parameters)==null?void 0:Y.docs)==null?void 0:J.source}}};var Q,X,Z;v.parameters={...v.parameters,docs:{...(Q=v.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  render: Template,
  name: 'With Target (A2)',
  args: {
    ...defaultArgs,
...
} satisfies Story`,...(se=(ne=y.parameters)==null?void 0:ne.docs)==null?void 0:se.source}}};var re,ie,le;f.parameters={...f.parameters,docs:{...(re=f.parameters)==null?void 0:re.docs,source:{originalSource:`{
...
} satisfies Story`,...(le=(ie=f.parameters)==null?void 0:ie.docs)==null?void 0:le.source}}};var oe,ce,de;k.parameters={...k.parameters,docs:{...(oe=k.parameters)==null?void 0:oe.docs,source:{originalSource:`{
...
} satisfies Story`,...(de=(ce=k.parameters)==null?void 0:ce.docs)==null?void 0:de.source}}};const Te=["WithRef","WithAttributes","Defaults","WithLongText","WithLongTextIconAndExternalIcon","WithIcon","WithExternalIcon","WithColor","WithTarget","WithDownload","WithAriaDescribedby","WithAriaCurrent","WithOnClick"],He=Object.freeze(Object.defineProperty({__proto__:null,Defaults:d,WithAriaCurrent:f,WithAriaDescribedby:y,WithAttributes:c,WithColor:b,WithDownload:h,WithExternalIcon:g,WithIcon:u,WithLongText:m,WithLongTextIconAndExternalIcon:p,WithOnClick:k,WithRef:o,WithTarget:v,__namedExportsOrder:Te,default:Ae},Symbol.toStringTag,{value:"Module"}));export{He as L};
//# sourceMappingURL=Link.test.stories-DQZciYOF.js.map
