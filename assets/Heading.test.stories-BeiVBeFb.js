import{j as n}from"./iframe-s2_bNgHU.js";import{H as i}from"./index-CJpzHRrE.js";import{h as y}from"./base-props.types-B340BQPQ.js";const S=[1,2,3,4,5],{expect:t,within:b}=__STORYBOOK_MODULE_TEST__,x={component:i,title:"Tester/Heading",argTypes:{ref:{table:{disable:!0}},className:{table:{disable:!0}},id:{table:{disable:!0}},lang:{table:{disable:!0}},"data-testid":{table:{disable:!0}},canBeManuallyFocused:{table:{disable:!0}},children:{table:{disable:!0},control:"text"},hasSpacing:{table:{disable:!0}},as:{table:{disable:!0}},level:{table:{disable:!0}}},tags:["test"],parameters:{imageSnapshot:{disableSnapshot:!1}}},w="h2",r={as:w,level:2,children:"Dette er en heading"},l={name:"With Ref (FA1)",args:{...r,ref:e=>{e&&(e.id="dummyIdForwardedFromRef")}},argTypes:{ref:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:e})=>{const a=b(e).getByRole("heading");await t(a).toHaveAttribute("id","dummyIdForwardedFromRef")}},o={name:"With Attributes (FA2-5)",args:{...r,id:"htmlId",className:"dummyClassname",lang:"nb","data-testid":"123ID"},argTypes:{id:{table:{disable:!1}},className:{table:{disable:!1}},lang:{table:{disable:!1}},"data-testid":{table:{disable:!1}}},parameters:{a11y:{test:"off"}},play:async({canvasElement:e})=>{const a=b(e).getByRole("heading");await t(a).toHaveClass("dummyClassname"),await t(a).toHaveAttribute("id","htmlId"),await t(a).toHaveAttribute("lang","nb"),await t(a).toHaveAttribute("data-testid","123ID")}},v=e=>n.jsx(n.Fragment,{children:S.map((s,a)=>n.jsx(i,{...e,level:s,children:`Heading level ${s}`},`level_${a}`))}),d={render:v,name:"Defaults All Levels (A1, A2)",args:{...r},play:async({canvasElement:e})=>{const a=b(e).getAllByRole("heading",{level:2});for(const[A,f]of a.entries())await t(f).toBeInTheDocument(),await t(f.classList.toString()).toContain(`heading_level${S[A]}`)}},c={render:v,name:"Defaults All Levels On Small Screen (A1, A2)",args:{...r},globals:{viewport:{value:"--breakpoint-xs"}}},g={render:v,name:"With Spacing All Levels (A4)",args:{...r,hasSpacing:!0},argTypes:{hasSpacing:{table:{disable:!1}}}},m={render:v,name:"With Spacing All Levels On Small Screen (A4)",args:{...r,hasSpacing:!0},argTypes:{hasSpacing:{table:{disable:!1}}},globals:{viewport:{value:"--breakpoint-xs"}}},T=e=>n.jsx(n.Fragment,{children:y.map(s=>n.jsx(i,{...e,as:s,children:`Heading ${s}`},`heading-${s}`))}),p={render:T,name:"With As (B1)",args:{...r},play:async({canvasElement:e})=>{const a=b(e).getAllByRole("heading");for(const[A,f]of a.entries())await t(f.tagName).toBe(y[A].toLocaleUpperCase())}},W=e=>n.jsxs(n.Fragment,{children:[n.jsxs(i,{...e,hasSpacing:!0,children:["Dette er den ",n.jsx("a",{href:"https://www.skatteetaten.no",children:"fyneste markup headingen"}),n.jsx("em",{children:" som finnes i italic "}),n.jsx("strong",{children:"og strong "}),n.jsx("mark",{children:"mark "}),n.jsx("code",{children:"code "}),"med spacing under og en skrivefeil"]}),n.jsx(i,{...e})]}),u={render:W,name:"With Markup And String (A3, B2)",args:{...r,children:"Dette er den fineste string headingen uten markup"},argTypes:{children:{table:{disable:!1},control:{disable:!0}}}},h={render:e=>n.jsx(i,{...e}),args:{...r,canBeManuallyFocused:!0},argTypes:{canBeManuallyFocused:{table:{disable:!1}}},play:async({canvasElement:e})=>{const a=b(e).getByRole("heading");a.focus(),await t(a).toBeInTheDocument(),await t(a).toHaveAttribute("tabIndex","-1")}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  name: 'With Ref (FA1)',
  args: {
    ...defaultArgs,
...
} satisfies Story`,...h.parameters?.docs?.source}}};const B=["WithRef","WithAttributes","Defaults","DefaultsMobile","LevelsWithSpacing","LevelsWithSpacingMobile","WithAs","WithMarkup","WithCanBeManuallyFocused"],D=Object.freeze(Object.defineProperty({__proto__:null,Defaults:d,DefaultsMobile:c,LevelsWithSpacing:g,LevelsWithSpacingMobile:m,WithAs:p,WithAttributes:o,WithCanBeManuallyFocused:h,WithMarkup:u,WithRef:l,__namedExportsOrder:B,default:x},Symbol.toStringTag,{value:"Module"}));export{D as H};
//# sourceMappingURL=Heading.test.stories-BeiVBeFb.js.map
