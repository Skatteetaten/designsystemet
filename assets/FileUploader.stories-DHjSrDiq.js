import{j as i}from"./jsx-runtime-BjG_zV1W.js";import{r as S}from"./index-D_ouKaeX.js";import{d as V}from"./index-ChzTQA-a.js";import{c as h,C as H}from"./index-DzkGBFys.js";import{c as e}from"./helpers-B7KPg_So.js";import{S as C}from"./icon.systems-BnMBg8hx.js";import{e as I}from"./stories.utils-Ys3NG0dr.js";const $={component:h,title:"Komponenter/FileUploader",argTypes:{classNames:{control:!1,table:{category:e.props}},acceptedFileFormatsDisplay:{table:{category:e.props}},description:{table:{category:e.props}},fileIconTitle:{table:{category:e.props}},errorMessage:{table:{category:e.props}},helpSvgPath:{options:Object.keys(C),mapping:C,table:{category:e.props,defaultValue:{summary:"HelpSimpleSVGpath"}}},helpText:{table:{category:e.props}},hideLabel:{table:{category:e.props}},invalidCharacterRegexp:{control:"text",table:{category:e.props}},isUploading:{table:{category:e.props}},label:{table:{category:e.props}},acceptedFileFormats:{table:{category:e.props}},shouldNormalizeFileName:{table:{category:e.props}},showRequiredMark:{table:{category:e.props}},titleHelpSvg:{table:{category:e.props,defaultValue:{summary:V.t("Shared:shared.Help")}}},uploadedFiles:{control:!1,table:{category:e.props}},uploadResult:{control:!1,table:{category:e.props}},multiple:{table:{category:e.htmlAttribute}},children:{table:{category:e.props}},acceptedFileFormatsDescription:{table:{category:e.props}},onFileDelete:{table:{category:e.event}},onFileDownload:{table:{category:e.event}},onFileChange:{table:{category:e.event}},onHelpToggle:{control:!1,table:{category:e.event}}},args:{helpText:"Hjelpetekst",label:"Ledetekst",acceptedFileFormats:[".pdf",".jpeg"],uploadedFiles:[{name:"test.pdf",href:"https://i.imgur.com/guZeGcr.png"},{name:"test.jpg"},{name:"test.png",href:"http://localhost:4400/designsystem_illustrasjon.png"}],onFileDelete:p=>(console.log(p),!0)}},f={};async function J(p){return await new Promise(n=>setTimeout(n,500)),p?Response.json({},{status:400}):Response.json({})}function A(p,n){return J(n)}function G(p,n){return J(n)}const u={render:p=>{const[n,b,y,U,j]=h.useFileUploader(),[d,E]=S.useState(!1),[F,c]=S.useState(""),M=async a=>(await G(a.name,d)).ok?(j(a),!0):!1,k=async a=>n.uploadedFiles.length>0?(c("Du har allerede lastet opp en fil. Fjern filen først om du ønsker å laste opp en annen fil i stedet"),Promise.reject()):a.length>1?(c("Det er ikke lov med flere filer (dette kan bare skje med drag and drop)"),Promise.reject()):(y(),(await A(a[0],d)).ok?(b(a),!0):(U(a,[{error:"det har skjedd noe feil",files:[{name:a[0].name}]}]),!1));return i.jsxs(i.Fragment,{children:[i.jsx(H,{checked:d,onChange:()=>E(!d),children:"La nettverkskall feile"}),i.jsx(h,{label:"Last opp et dokument",acceptedFileFormats:[".pdf",".jpeg",".png"],multiple:!1,...n,errorMessage:F,onFileDelete:M,onFileChange:k})]})}};u.parameters=I;const m={render:p=>{const n=o=>{const l=[];for(let t=0;t<o;t++){const g=new Promise((v,r)=>{Math.random()<.5?v({href:"https://skatteetaten.github.io/designsystemet/"}):r("Promise rejected")});l.push(g)}return l},[b,y,U,j,d]=h.useFileUploader(),[E,F]=S.useState(),[c,M]=S.useState(!0),k="http://localhost:9090/test",a=async o=>{if(await new Promise(t=>setTimeout(t,1500)),c)return d(o),!0;let l=!0;return await fetch(k,{method:"DELETE"}).then(t=>{t.ok?d(o):l=!1}),l},P=async o=>{if(U(),F(""),o.some(r=>r.size>9e5)){F("Filen er for stor");return}const l=[],t=[];let g=[];if(c?g=n(o.length):g=o.map(r=>fetch(k,{method:"POST",body:r}).then(s=>(console.log(s),s.ok?s.json():Promise.reject(s)))),(await Promise.allSettled(g)).forEach((r,s)=>{r.status==="fulfilled"?(console.log("FULLLFILLED",r),l.push({name:o[s].name,href:r.value.href,id:Math.random().toString(36).substring(2,10)})):r.status==="rejected"&&(console.log("REJECT",r),t.push({name:o[s].name,reason:r.reason.statusText,id:Math.random().toString(36).substring(2,10)}))}),t.length){const r=`${t.length} av ${o.length} filer ble ikke lastet Opp`;j(t.map(({name:s,reason:x})=>({name:s,errorMessage:x})),[{error:r,files:t.map(({name:s,id:x})=>({name:s,id:x}))}],l)}else y(l)};return i.jsxs(i.Fragment,{children:[i.jsx(H,{checked:c,onChange:()=>M(!c),children:"Bruk mockUpload"}),i.jsx(h,{label:"Dokumentasjon og grunnlag",helpText:"Trenger du hjelp?",acceptedFileFormats:[".pdf",".jpeg",".png"],invalidCharacterRegexp:/e/g,shouldNormalizeFileName:!0,...b,errorMessage:E??"",multiple:!0,onFileDelete:a,onFileChange:P})]})}};m.parameters=I;var D,L,T;f.parameters={...f.parameters,docs:{...(D=f.parameters)==null?void 0:D.docs,source:{originalSource:"{} satisfies Story",...(T=(L=f.parameters)==null?void 0:L.docs)==null?void 0:T.source}}};var w,_,R;u.parameters={...u.parameters,docs:{...(w=u.parameters)==null?void 0:w.docs,source:{originalSource:`{
