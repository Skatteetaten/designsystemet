import{c as k,r as l,j as e}from"./iframe-BQX7p2fO.js";import{S as r,O as j}from"./index-BWAuWBOL.js";import{C as S}from"./index-DE3ap_ny.js";import{R as m,E as h,C as x}from"./index-Dz9Mp0Gs.js";import{P as g,L as n}from"./index-BLTwn-id.js";import{e as E}from"./stories.utils-B3vRc2tk.js";const b={component:r,title:"Komponenter/StepList",argTypes:{children:{control:!1,table:{category:k.props}}},args:{children:[e.jsx(r.Step,{stepNumber:1,title:"Overskrift",variant:"active",children:"Innhold"},"step2"),e.jsx(r.Step,{stepNumber:2,title:"Overskrift",children:"Innhold"},"step1")]}},a={},i={render:N=>{const s=l.useId(),[t,o]=l.useState(1),[d,f]=l.useState(void 0),[u,c]=l.useState(!1),p=()=>{const v=t+1;o(v)};return e.jsxs(r,{children:[t>=1&&e.jsx(r.Step,{id:`${s}-1`,variant:t===1?"active":"passive",title:"Hva holder du på med?",stepNumber:1,shouldAutoFocusWhenActive:!1,onEdit:t>1&&t<5?()=>o(1):void 0,onNext:p,children:"Varer og tjenester"}),t>=2&&e.jsx(r.Step,{id:`${s}-2`,variant:t===2?"active":"passive",title:"Hva gjør du?",stepNumber:2,onEdit:t>2&&t<5?()=>o(2):void 0,onNext:p,children:"Selger"}),t>=3&&e.jsx(r.Step,{id:`${s}-3`,variant:t===3?"active":"passive",title:"Salg av varer og tjenester",stepNumber:3,onEdit:t>3&&t<5?()=>o(2):void 0,onNext:()=>{d?p():c(!0)},children:t===3?e.jsxs(e.Fragment,{children:[e.jsxs(j,{title:"Hva er egen regning og risiko?",children:[e.jsxs(g,{hasSpacing:!0,children:["At du driver for egen regning og risiko innebærer at det er du som har det økonomiske ansvaret for gjeld og forpliktelser. Det innebærer også at det er du som dekker kostnadene i virksomheten, for eksempel kostnader til materiale eller andre driftskostnader."," "]}),e.jsx(g,{children:"I tillegg vil du ha det kontraktsmessige ansvaret for at oppdrag blir utført og ansvar for å dekke et eventuelt underskudd."})]}),e.jsxs(m,{legend:"Selger du varer og tjenester for egen regning og risiko?",errorMessage:u?"Kryss av hvorvidt du selger varer  og tjenester":void 0,hideLegend:!0,onChange:v=>{c(!1),f(v.target.value)},children:[e.jsx(m.Radio,{id:"step3radio",value:"ja",children:"Ja"}),e.jsx(m.Radio,{value:"nei",children:"Nei"})]}),e.jsx(h,{showErrorSummary:u,children:e.jsx(h.Error,{referenceId:"step3radio",children:"Selger du varer og tjenester for egen regning?"})})]}):e.jsx("div",{children:d})}),t>=4&&e.jsx(r.Step,{id:`${s}-4`,variant:t===4?"active":"passive",title:"Oppsummering før innsending",stepNumber:4,onNext:p,children:t===4?e.jsx(S,{color:"ochre",className:"topSpacingS",children:e.jsxs(S.Content,{children:[e.jsxs(n,{children:[e.jsx(n.Element,{children:"Du jobber med varer og tjenester"}),e.jsx(n.Element,{children:"Du selger"}),e.jsx(n.Element,{children:"Du selger for egen regning og risiko"})]}),e.jsx(x,{children:"Jeg bekrefter at opplysningene ovenfor stemmer"})]})}):e.jsx("div",{children:"Oppsummering"})}),t>=5&&d==="ja"&&e.jsxs(r.Step,{id:`${s}-5`,title:"Vårt veiledende svar",variant:"positiveResult",stepNumber:5,introTitle:"Virksomheten skal registreres som særavgiftspliktig.",introTitleAs:"h4",introContent:e.jsx(g,{children:"For å bli registrert må du sende en søknad til Skatteetaten. Nedenfor beskriver vi hvordan du går frem og hva du må dokumentere."}),children:[e.jsx(g,{children:"Du må gjøre følgende:"}),e.jsxs(n,{as:"ol",children:[e.jsx(n.Element,{children:"Du må bestemme hvilken organisasjonsform som passer best."}),e.jsxs(n.Element,{children:["Registrere bedriften i Enhetsregisteret ved å fylle ut Samordnet","registermelding"]}),e.jsxs(n.Element,{children:["Dersom bedriften din har avgiftspliktig omsetning og/eller uttak","overstiger kr 50 000 i løpet av en 12 måneders periode, må du","registrere virksomheten i Merverdiavgiftsregisteret."]})]})]}),t>=5&&d==="nei"&&e.jsx(r.Step,{id:`${s}-5`,title:"neutralt resultat",variant:"neutralResult",stepNumber:5,children:"more brødtekst"})]})}};i.parameters=E;a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:"{} satisfies Story",...a.parameters?.docs?.source}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
        ...
        if (step3) {
          ...
          setHasStep3Error(true);
            ...
            {activeStep === 3 ? <>
                ...
                <RadioGroup legend={'Selger du varer og tjenester for egen regning og risiko?'} errorMessage={hasStep3Error ? 'Kryss av hvorvidt du selger varer  og tjenester' : undefined} hideLegend onChange={(e): void => {
...
} satisfies Story`,...i.parameters?.docs?.source}}};const L=["Preview","Examples"],P=Object.freeze(Object.defineProperty({__proto__:null,Examples:i,Preview:a,__namedExportsOrder:L,default:b},Symbol.toStringTag,{value:"Module"}));export{i as E,P as S};
//# sourceMappingURL=StepList.stories-Bk1fjiww.js.map
