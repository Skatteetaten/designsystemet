import{j as R,d as s}from"./iframe-_BeEUj9n.js";import{D as T}from"./DatePickerCalendar-BqUDbnkt.js";const{expect:e,fireEvent:S,within:c}=__STORYBOOK_MODULE_TEST__,_=t=>R.jsx(T,{...t,selectedDate:new Date(t.selectedDate),minDate:new Date(t.minDate),maxDate:new Date(t.maxDate)}),I=new Date("2024-01-15"),M={component:T,title:"Tester/DatePicker/Calendar",argTypes:{ref:{table:{disable:!0}},className:{table:{disable:!0}},id:{table:{disable:!0}},lang:{table:{disable:!0}},"data-testid":{table:{disable:!0}},disabledDates:{table:{disable:!0}},selectedDate:{table:{disable:!0},control:"date"},minDate:{table:{disable:!0},control:"date"},maxDate:{table:{disable:!0},control:"date"},onSelectDate:{table:{disable:!0}},onTabKeyOut:{table:{disable:!0}}},render:_,tags:["test"],parameters:{mockDate:I,imageSnapshot:{disableSnapshot:!1}}},l={selectedDate:I,onSelectDate:()=>{Function.prototype()}},u={name:"With Ref (FA1)",args:{...l,ref:t=>{t&&(t.id="dummyIdForwardedFromRef")}},argTypes:{ref:{table:{disable:!1}}},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:t})=>{const n=c(t).getAllByRole("generic")[1];await e(n).toHaveAttribute("id","dummyIdForwardedFromRef")}},b={name:"With Attributes (FA2-5)",args:{...l,id:"htmlId",className:"dummyClassname",lang:"en","data-testid":"123ID"},argTypes:{id:{table:{disable:!1}},className:{table:{disable:!1}},lang:{table:{disable:!1}},"data-testid":{table:{disable:!1}}},parameters:{a11y:{test:"off"}},play:async({canvasElement:t})=>{const n=c(t).getAllByRole("generic")[1];await e(n).toHaveAttribute("id","htmlId"),await e(n).toHaveClass("dummyClassname"),await e(n).toHaveAttribute("lang","en"),await e(n).toHaveAttribute("data-testid","123ID")}},p={name:"Defaults (A1 delvis, B1, B2)",args:{...l},argTypes:{},play:async({canvasElement:t})=>{const a=c(t),n=`${s.t("ds_forms:datepicker.PreviousMonth")} ${s.t("ds_forms:datepicker.December")} 2023`,r=`${s.t("ds_forms:datepicker.NextMonth")} ${s.t("ds_forms:datepicker.February")} 2024`;await e(a.getByRole("button",{name:n})).toBeInTheDocument(),await e(a.getByRole("button",{name:r})).toBeInTheDocument(),await e(a.getByRole("combobox",{name:s.t("ds_forms:datepicker.SelectMonth")})).toBeInTheDocument(),await e(a.getByRole("textbox",{name:s.t("ds_forms:datepicker.Year")})).toBeInTheDocument();const o=a.getByRole("table"),d=o.querySelector("caption"),i=o.querySelectorAll("td"),m=o.querySelectorAll("button"),W=o.querySelectorAll('button[tabindex="0"]');await e(o).toBeInTheDocument(),await e(d).toBeInTheDocument(),await e(i.length).toBe(m.length),await e(W.length).toBe(1);const A=a.getAllByText("15")[0];await e(A).toHaveAttribute("aria-label","I dag 15. Januar 2024"),await e(A).toHaveAttribute("aria-current","true"),await e(A).toHaveAttribute("tabindex","0")}},D={name:"WithSelectedDate (B2)",args:{...l,selectedDate:new Date("2024-01-31")},argTypes:{selectedDate:{table:{disable:!1}}},play:async({canvasElement:t})=>{const n=c(t).getByText("31");await e(n).toHaveAttribute("aria-current","true")}},k=new Date("2024-01-15");k.setHours(1,1,1,1);const y={name:"With MinDate (A3 delvis)",args:{...l,minDate:k},argTypes:{minDate:{table:{disable:!1}}},play:async({canvasElement:t})=>{const r=c(t).getByRole("table").querySelectorAll("button:disabled");await e(r.length).toBe(14)}},H=new Date("2024-01-15");H.setHours(1,1,1,1);const g={name:"With MaxDate (A3 delvis)",args:{...l,maxDate:H},argTypes:{maxDate:{table:{disable:!1}}},play:async({canvasElement:t})=>{const r=c(t).getByRole("table").querySelectorAll("button:disabled");await e(r.length).toBe(20)}},v={name:"With MaxDate Where Selected Date Is Within The Range",args:{...l,selectedDate:new Date("2024-01-16"),maxDate:new Date("2024-01-15")},argTypes:{selectedDate:{table:{disable:!1}},maxDate:{table:{disable:!1}}},play:async({canvasElement:t})=>{const a=c(t),n=a.getByText("16");await e(n).toHaveAttribute("tabindex","-1");const r=a.getByText("15");await e(r).toHaveAttribute("tabindex","0")}},h={name:"With Breakpoint-mobile (A1 delvis)",args:{...l},argTypes:{},globals:{viewport:{value:"--mobile"}}},w={name:"Click And Change Month And Year (A5 delvis)",args:{...l},argTypes:{},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:t})=>{const a=c(t),n=`${s.t("ds_forms:datepicker.PreviousMonth")} ${s.t("ds_forms:datepicker.December")} 2023`,r=a.getByRole("button",{name:n}),o=`${s.t("ds_forms:datepicker.NextMonth")} ${s.t("ds_forms:datepicker.February")} 2024`,d=a.getByRole("button",{name:o}),i=a.getByRole("combobox",{name:s.t("ds_forms:datepicker.SelectMonth")}),m=a.getByRole("textbox",{name:s.t("ds_forms:datepicker.Year")});await e(i).toHaveValue("0"),await e(m).toHaveValue("2024"),await S.click(r),await e(i).toHaveValue("11"),await e(m).toHaveValue("2023"),await S.click(d),await e(i).toHaveValue("0"),await e(m).toHaveValue("2024")}},f={name:"With DisabledDates",args:{...l,disabledDates:[new Date("2024-01-04"),new Date("2024-01-06"),new Date("2024-01-07"),new Date("2024-01-13"),new Date("2024-01-14"),new Date("2024-01-20"),new Date("2024-01-21"),new Date("2024-01-27"),new Date("2024-01-28"),new Date("2024-02-03T09:40:00"),new Date(2024,1,4)],minDate:new Date("2023-12-01"),maxDate:new Date("2024-02-10")},argTypes:{disabledDates:{table:{disable:!1}}},play:async({args:t,canvasElement:a})=>{const o=c(a).getByRole("table").querySelectorAll("button:disabled");await e(o.length).toBe(t.disabledDates?.length)}},B={name:"With DisabledDate As Value",args:{...l,disabledDates:[new Date("2024-01-15")]},argTypes:{disabledDates:{table:{disable:!1}}},play:async({canvasElement:t})=>{const n=c(t).getByText("16");await e(n).toHaveAttribute("tabindex","0")}},x={name:"With Accessible Day Names",args:{...l},parameters:{imageSnapshot:{disableSnapshot:!0}},play:async({canvasElement:t})=>{const r=c(t).getByRole("table").querySelectorAll("th");await e(r.length).toBe(7);const o=r[0],d=o.querySelector('span[aria-hidden="true"]'),i=o.querySelectorAll("span")[1];await e(d).toBeInTheDocument(),await e(d).toHaveTextContent(s.t("ds_forms:datepicker.Mon")),await e(i).toHaveTextContent(s.t("ds_forms:datepicker.Monday"))}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  name: 'With Ref (FA1)',
  args: {
    ...defaultArgs,
  ...
  play: async ({
    ...
    const ariaHiddenSpan = firstHeaderCell.querySelector('span[aria-hidden="true"]');
    const srOnlySpan = firstHeaderCell.querySelectorAll('span')[1];
    await expect(ariaHiddenSpan).toBeInTheDocument();
    await expect(ariaHiddenSpan).toHaveTextContent(dsI18n.t('ds_forms:datepicker.Mon'));
    await expect(srOnlySpan).toHaveTextContent(dsI18n.t('ds_forms:datepicker.Monday'));
  }
} satisfies Story`,...x.parameters?.docs?.source}}};const E=["WithRef","WithAttributes","Defaults","WithSelectedDate","WithMinDate","WithMaxDate","WithMaxDateWhereSelectedDateIsWithinTheRange","WithBreakpointMobile","ClickAndChangeMonthAndYear","WithDisabledDates","WithDisabledDateAsValue","WithAccessibleDayNames"],P=Object.freeze(Object.defineProperty({__proto__:null,ClickAndChangeMonthAndYear:w,Defaults:p,WithAccessibleDayNames:x,WithAttributes:b,WithBreakpointMobile:h,WithDisabledDateAsValue:B,WithDisabledDates:f,WithMaxDate:g,WithMaxDateWhereSelectedDateIsWithinTheRange:v,WithMinDate:y,WithRef:u,WithSelectedDate:D,__namedExportsOrder:E,default:M},Symbol.toStringTag,{value:"Module"}));export{P as D};
//# sourceMappingURL=DatePickerCalendar.test.stories-BZaEj5ib.js.map
