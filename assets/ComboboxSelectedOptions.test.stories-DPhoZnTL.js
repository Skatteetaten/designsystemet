import{j as h}from"./iframe-CdXtTKZQ.js";import{C as g}from"./ComboboxSelectedOptions-BdSatC4Q.js";import"./index-C6J3KzFu.js";import"./index-D0xxaDHU.js";import"./index-CDWtp_lT.js";import"./index-CVW4skVE.js";import"./index-BEPTjI1-.js";import"./index-DUrzBgqO.js";import"./Combobox.module-DGtBY5ID.js";const{expect:o,fn:d,userEvent:R,within:v}=__STORYBOOK_MODULE_TEST__,k={component:g,title:"Tester/Combobox/SelectedOptions",decorators:[e=>h.jsx(e,{})],argTypes:{multiple:{table:{disable:!0}},selectedValues:{table:{disable:!0}},onRemoveValue:{table:{disable:!0}}},tags:["test"]},f=[{label:"Norge",value:"no"},{label:"Sverige",value:"se"},{label:"Danmark",value:"dk"}],b={multiple:!0,selectedValues:f,onRemoveValue:d()},a={name:"onRemoveValue callback (A11)",args:{...b,onRemoveValue:d()},play:async({args:e,canvasElement:s})=>{const t=v(s).getByRole("button",{name:/Norge/i});await R.click(t),await o(e.onRemoveValue).toHaveBeenCalledTimes(1),await o(e.onRemoveValue).toHaveBeenCalledWith({label:"Norge",value:"no"})}},n={name:"Disabled chips",args:{...b,disabled:!0},parameters:{chromatic:{disableSnapshot:!1}},play:async({canvasElement:e})=>{const l=v(e).getAllByRole("button");for(const t of l)await o(t).toBeDisabled()}};var c,i,r;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`{
...
//# sourceMappingURL=ComboboxSelectedOptions.test.stories-DPhoZnTL.js.map
