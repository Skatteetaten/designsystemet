...
export const autoCompletePropDescription =
...
export const defaultHelpButtonTitle = dsI18n.t('Shared:shared.Help');
export const defaultSpinnerLabel = dsI18n.t('ds_progress:spinner.LoadingLabel');
