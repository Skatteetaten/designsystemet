...
export type IconDiscriminatedTitleProps =
  | {
      ...
      title?: string;
      /**
       * Hvis svg-en er meningsbærende og ikke bare pynt/dekor skal elementet ha
       * ariaLabel. Merk at aria-label vises kun når "title"-prop ikke allerede
       * er oppgitt.
       */
      ariaLabel?: never;
    }
...
export type IconDiscriminatedVariantProps =
  | {
      /**
       * Definerer detaljnivå på et ikon. "systemIcon" har en viewBox på 0 0 24
       * 24, mens "themeIcon" har en viewBox på 0 0 48 48 De tilgjengelige
       * størrelsene under "size" prop er avhengig av variant.
       */
      variant?: Extract<IconVariant, 'systemIcon'>;
      /**
       * Subset av Size-type avhengig av "variant"-prop. Setter width og height
       * på selve ikonet basert på Size verdi.
       */
