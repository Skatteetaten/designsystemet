...
export interface NavigationTileComponentCommonProps
   ...
   * annet domene. Ikon ikke synlig dersom 'size' er 'extraLarge'.
   */
  isExternal?: boolean;
  ...
  /**
   * Skjuler pil-ikonet. Ikonet er alltid skjult dersom 'size' er 'extraLarge'
   * eller dersom 'isExternal' er 'true'
   */
  hideArrowIcon?: boolean;
  /**
   * Om NavigationTile skal inneholde spinner. Hvis svgPath også er satt,
   * erstatter spinneren ikonet.
   */
  hasSpinner?: boolean;
