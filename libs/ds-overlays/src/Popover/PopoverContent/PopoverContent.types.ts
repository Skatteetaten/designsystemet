...
export interface PopoverContentProps extends BaseProps {
  ...
  /**
   * Innhold i popup-boksen. NB! Hvis as-prop er satt til span, må innholdet
   * være en string eller et HTML-element som er tillatt i en span. Finn ut
   * hvilke elementer som er tillatt i en span:
   * {@link https://developer.mozilla.org/en-US/docs/Web/HTML/Guides/Content_categories#phrasing_content}.
   */
  children: ReactNode;
