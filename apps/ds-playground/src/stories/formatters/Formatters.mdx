...
Designsystemet tilbyr en funksjon formatter som grupperer en rekke typer tall. I tillegg tilbys også en rekke wrapper-funksjoner som benytter formaterignsfunksjonen og som gjør det enklere å håndtere de ulike talltypene. For å formatere inputfelter har designsystemet også en hook useFormattedInput.
