...
<DocIntro url="https://www.skatteetaten.no/stilogtone/designsystemet/komponenter/accordion/" />
...
## Standard med høyreikon

<Canvas of={AccordionStories.StandardRightIcon} />

## Liten med venstreikon

<Canvas of={AccordionStories.SmallLeftIcon} />

## Bakgrunnsfarge

<Canvas of={AccordionStories.BackgroundColor} />
