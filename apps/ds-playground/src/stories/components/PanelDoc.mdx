...
<div id="panel-padding-prop">### 1. Panel med luft styrt av padding-prop</div>
...
<Panel
  ...
  >Lorem ipsum dolor sit amet.</Panel>
```

Resultatet blir da at innholdet i Panel strekker seg 100%. Hvis derimot `renderIcon` eller `imageSource` så må det gjøres endring i CSS-grid. Panel sin grid-template endres med media-query når ikon eller illustrasjon er satt.
