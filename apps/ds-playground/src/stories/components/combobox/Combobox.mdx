...
- **Visuell gruppering**: Alternativer med samme `group`-verdi vises sammen under en felles overskrift, uavhengig av hvor de ligger i options-arrayet
- **Rekkefølge bevares**: Grupper opprettes basert på rekkefølgen de først forekommer i options-arrayen
