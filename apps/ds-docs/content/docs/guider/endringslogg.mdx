...
## Versjon 3.0.0 – 10. september 2026

Dette er et fiktivt eksempel på hvordan endringer i en release dokumenteres. Innholdet oppdateres før lansering.

### Feilrettinger og forbedringer

- Button: Fiktivt eksempel: Knappene har fått oppdatert tastaturnavigasjon for bedre støtte ved bruk av tastatur.
- Accordion: Fiktivt eksempel: Komponenten har fått forbedret håndtering av lange titler på små skjermer.
- Skjemakomponenter: Fiktivt eksempel: Komponentene gir tydeligere tilbakemelding når et obligatorisk felt mangler en verdi.
- Containere: Fiktivt eksempel: Containerne har fått justert responsiv oppførsel ved høy zoom.

### Oppdatert dokumentasjon og eksempler

- Designtokens: Fiktivt eksempel: Dokumentasjonen har fått et eksempel på bruk av et semantisk token for avstand mellom beslektede innholdsseksjoner.

Se [migreringsguiden for versjon 3.0](/guider/migrering/versjon_3/).
